...
public abstract class AbstractInputBuffer<S> implements InputBuffer {
	...
	/**
	 * Implementations are expected to call {@link Request2#setStartTime(long)}
	...
	public InputBuffer getInputStreamInputBuffer() {
		return inputStreamInputBuffer;
	}

	public void setInputStreamInputBuffer(InputBuffer inputStreamInputBuffer) {
		this.inputStreamInputBuffer = inputStreamInputBuffer;
	}

	public InputFilter[] getFilterLibrary() {
		return filterLibrary;
	}

	public void setFilterLibrary(InputFilter[] filterLibrary) {
		this.filterLibrary = filterLibrary;
	}

	public InputFilter[] getActiveFilters() {
		return activeFilters;
	}

	public void setActiveFilters(InputFilter[] activeFilters) {
	...
	public static boolean[] getHttpTokenChar() {
		return HTTP_TOKEN_CHAR;
	}
