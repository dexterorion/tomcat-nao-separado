...
public abstract class AbstractProcessor2<S> implements Processor<S>,
		WebConnection {

	private static final StringManager3 sm = StringManager3
			.getManager(Constants27.getPackage());
	...
	public AbstractProcessor2(HttpUpgradeHandler httpUpgradeHandler,
