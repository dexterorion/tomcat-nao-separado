...
public class Lock {
	...
	private static final int APR_LOCK_FCNTL        = 0; /** fcntl() */
	private static final int APR_LOCK_FLOCK        = 1; /** flock() */
	private static final int APR_LOCK_SYSVSEM      = 2; /** System V Semaphores */
	private static final int APR_LOCK_PROC_PTHREAD = 3; /** POSIX pthread process-based locking */
	private static final int APR_LOCK_POSIXSEM     = 4; /** POSIX semaphore process-based locking */
	private static final int APR_LOCK_DEFAULT      = 5; /** Use the default process lock */
