...
public class OS {
	...
	private static final boolean IS_UNIX = is(UNIX);
	private static final boolean IS_NETWARE = is(NETWARE);
	private static final boolean IS_WIN32 = is(WIN32);
	private static final boolean IS_WIN64 = is(WIN64);
	private static final boolean IS_LINUX = is(LINUX);
	private static final boolean IS_SOLARIS = is(SOLARIS);
	private static final boolean IS_BSD = is(BSD);
	private static final boolean IS_MACOSX = is(MACOSX);
	...
	public static int getNetware() {
		return NETWARE;
	}

	public static int getWin32() {
		return WIN32;
	}

	public static int getWin64() {
		return WIN64;
	}

	public static int getLinux() {
		return LINUX;
	}

	public static int getSolaris() {
		return SOLARIS;
	}

	public static int getBsd() {
		return BSD;
	}
	...
	public static int getLogNotice() {
		return LOG_NOTICE;
	}
