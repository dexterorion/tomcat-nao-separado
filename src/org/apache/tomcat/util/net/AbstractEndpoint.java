...
import org.apache.tomcat.util.threads.ThreadPoolExecutor2;
/**
 *
 * @author fhanik
 * @author Mladen Turk
...
public abstract class AbstractEndpoint<S> {
    ...
    // -------------------------------------------------------------- Constants
    private static final StringManager3 sm = StringManager3.getManager("org.apache.tomcat.util.net.res");
     ...
     */
    private volatile boolean internalExecutor = false;
     ...
     */
    private AbstractEndpointAcceptor[] acceptors;
     ...
     */
    private int acceptorThreadCount = 0;
    ...
    public int getCurrentThreadCount() {
        if (executor!=null) {
            if (executor instanceof ThreadPoolExecutor2) {
                return ((ThreadPoolExecutor2)executor).getPoolSize();
            } else if (executor instanceof ResizableExecutor) {
    ...
    public int getCurrentThreadsBusy() {
        if (executor!=null) {
            if (executor instanceof ThreadPoolExecutor2) {
                return ((ThreadPoolExecutor2)executor).getActiveCount();
            } else if (executor instanceof ResizableExecutor) {
    ...
    public void createExecutor() {
        ...
        executor = new ThreadPoolExecutor2(getMinSpareThreads(), getMaxThreads(), 60, TimeUnit.SECONDS,taskqueue, tf);
        taskqueue.setParent( (ThreadPoolExecutor2) executor);
    }
    ...
    public void shutdownExecutor() {
        if ( executor!=null && internalExecutor ) {
            if ( executor instanceof ThreadPoolExecutor2 ) {
                ...
                ThreadPoolExecutor2 tpe = (ThreadPoolExecutor2) executor;
                tpe.shutdownNow();
    ...
    protected void unlockAccept() {
        ...
        for (AbstractEndpointAcceptor acceptor : acceptors) {
    ...
    protected final void startAcceptorThreads() {
        ...
        acceptors = new AbstractEndpointAcceptor[count];
     ...
     */
    protected abstract AbstractEndpointAcceptor createAcceptor();
    ...
    public void setKeystoreFile(String s ) {
        keystoreFile = adjustRelativePath(s,
                System.getProperty(Constants34.getCatalinaBaseProp()));
    }
	...
	public void setInternalExecutor(boolean internalExecutor) {
		this.internalExecutor = internalExecutor;
	}

	public LimitLatch getConnectionLimitLatch() {
		return connectionLimitLatch;
	}

	public void setConnectionLimitLatch(LimitLatch connectionLimitLatch) {
		this.connectionLimitLatch = connectionLimitLatch;
	}

	public AbstractEndpointAcceptor[] getAcceptors() {
		return acceptors;
	}

	public void setAcceptors(AbstractEndpointAcceptor[] acceptors) {
	...
	public String[] getSslEnabledProtocolsarr() {
		return sslEnabledProtocolsarr;
	}

	public void setSslEnabledProtocolsarr(String[] sslEnabledProtocolsarr) {
		this.sslEnabledProtocolsarr = sslEnabledProtocolsarr;
	}

	public static int getInitialErrorDelay() {
		return INITIAL_ERROR_DELAY;
	}

	public static int getMaxErrorDelay() {
		return MAX_ERROR_DELAY;
	}
