...
import org.apache.tomcat.util.net.SSLSupportCipherData;
...
public class JSSESupport implements SSLSupport, SSLSessionManager {
    ...
    private static final StringManager3 sm =
        StringManager3.getManager("org.apache.tomcat.util.net.jsse.res");
    ...
    public JSSESupport(SSLSocket sock){
        ssl=sock;
    ...
    public Integer getKeySize()
        throws IOException {
        // Look up the current SSLSession
        SSLSupportCipherData c_aux[] = {
                new SSLSupportCipherData("_WITH_NULL_", 0),
                new SSLSupportCipherData("_WITH_IDEA_CBC_", 128),
                new SSLSupportCipherData("_WITH_RC2_CBC_40_", 40),
                new SSLSupportCipherData("_WITH_RC4_40_", 40),
                new SSLSupportCipherData("_WITH_RC4_128_", 128),
                new SSLSupportCipherData("_WITH_DES40_CBC_", 40),
                new SSLSupportCipherData("_WITH_DES_CBC_", 56),
                new SSLSupportCipherData("_WITH_3DES_EDE_CBC_", 168),
                new SSLSupportCipherData("_WITH_AES_128_CBC_", 128),
                new SSLSupportCipherData("_WITH_AES_256_CBC_", 256)
        };
