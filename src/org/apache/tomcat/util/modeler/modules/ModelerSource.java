...
public abstract class ModelerSource {
     ...
     */
    @Deprecated
    public List<ObjectName> loadDescriptors( Registry2 registry, String location,
    ...
    protected InputStream getInputStream() throws IOException {
        if( source instanceof URL ) {
            ...
            setLocation(((File)source).getAbsolutePath());
    ...
    public abstract List<ObjectName> loadDescriptors(Registry2 registry,
            String type, Object source) throws Exception;
