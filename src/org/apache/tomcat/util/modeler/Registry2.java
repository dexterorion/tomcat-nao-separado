 ...
 */
public class Registry2 implements RegistryMBean, MBeanRegistration  {
    /**
     * The Log instance to which we will write our log messages.
     */
    private static final Log log = LogFactory.getLog(Registry2.class);

    // Support for the factory methods
    
    /** Will be used to isolate different apps and enhance security.
     */
    private static HashMap<Object,Registry2> perLoaderRegistries = null;

    /**
     * The registry instance created by our factory method the first time
     * it is called.
     */
    private static Registry2 registry = null;
     ...
     * @since 1.1
     */
    public static synchronized Registry2 getRegistry(Object key, Object guard) {
        ...
        if( perLoaderRegistries!=null ) {
            ...
            if( key != null ) {
                ...
                if( localRegistry == null ) {
                    localRegistry=new Registry2();
//                    localRegistry.key=key;
                    localRegistry.setGuardData(guard);
                    perLoaderRegistries.put( key, localRegistry );
                    return localRegistry;
                }
                if( localRegistry.getGuardData() != null &&
                        localRegistry.getGuardData() != guard ) {
        ...
        if( registry.getGuardData() != null &&
                registry.getGuardData() != guard ) {
            return null;
        }
        return (registry);
    }
    ...
    public static void setUseContextClassLoader( boolean enable ) {
        if( enable ) {
            perLoaderRegistries = new HashMap<Object,Registry2>();
        }
    }
	...
	public Object getGuardData() {
		return guard;
	}

	public void setGuardData(Object guard) {
		this.guard = guard;
	}
