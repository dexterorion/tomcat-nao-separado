...
public class CallParamRule extends Rule {
	 ...
	 */
	private ArrayStack<String> bodyTextStack;
	...
	public ArrayStack<String> getBodyTextStack() {
		return bodyTextStack;
	}

	public void setBodyTextStack(ArrayStack<String> bodyTextStack) {
		this.bodyTextStack = bodyTextStack;
	}
