...
public class Digester extends DefaultHandler2 {
	...
	private static IntrospectionUtilsPropertySource source[] = new IntrospectionUtilsPropertySource[] { new DigesterSystemPropertySource() };

	static {
		String className = System
				.getProperty("org.apache.tomcat.util.digester.PROPERTY_SOURCE");
		if (className != null) {
			IntrospectionUtilsPropertySource[] sources = new IntrospectionUtilsPropertySource[2];
			sources[1] = source[0];
			...
			for (int i = 0; i < cls.length && (!initialized); i++) {
				try {
					...
					IntrospectionUtilsPropertySource src = (IntrospectionUtilsPropertySource) clazz
							.newInstance();
					sources[0] = src;
					initialized = true;
				} catch (Throwable t) {
	 ...
	 */
	private ArrayStack<StringBuilder> bodyTexts = new ArrayStack<StringBuilder>();
	 ...
	 * @since 1.6
	 */
	private ArrayStack<List<Rule>> matches = new ArrayStack<List<Rule>>(10);
	 ...
	 */
	private HashMap<String, String> entityValidator = new HashMap<String, String>();
	 ...
	 */
	private HashMap<String, ArrayStack<String>> namespaces = new HashMap<String, ArrayStack<String>>();

	/**
	 * The parameters stack being utilized by CallMethodRule and CallParamRule
	 * rules.
	 */
	private ArrayStack<Object> params = new ArrayStack<Object>();
	 ...
	 */
	private boolean rulesValidation = false;

	/**
	 * Fake attributes map (attributes are often used for object creation).
	 */
	private Map<Class<?>, List<String>> fakeAttributes = null;
	...
	public static IntrospectionUtilsPropertySource[] getSource() {
		return source;
	}

	public static void setSource(IntrospectionUtilsPropertySource[] source) {
		Digester.source = source;
	}
	...
	public ArrayStack<StringBuilder> getBodyTexts() {
		return bodyTexts;
	}

	public void setBodyTexts(ArrayStack<StringBuilder> bodyTexts) {
		this.bodyTexts = bodyTexts;
	}

	public ArrayStack<List<Rule>> getMatches() {
		return matches;
	}

	public void setMatches(ArrayStack<List<Rule>> matches) {
	...
	public HashMap<String, String> getEntityValidator() {
		return entityValidator;
	}

	public void setEntityValidator(HashMap<String, String> entityValidator) {
	...
	public HashMap<String, ArrayStack<String>> getNamespaces() {
		return namespaces;
	}

	public void setNamespaces(HashMap<String, ArrayStack<String>> namespaces) {
		this.namespaces = namespaces;
	}

	public ArrayStack<Object> getParams() {
		return params;
	}

	public void setParams(ArrayStack<Object> params) {
		this.params = params;
	}
	...
	public ArrayStack<Object> getStack() {
		return stack;
	}

	public void setStack(ArrayStack<Object> stack) {
		this.stack = stack;
	}
	...
	public void setSaxLog(Log saxLog) {
		this.saxLog = saxLog;
	}

	public HashMap<String, ArrayStack<Object>> getStacksByName() {
		return stacksByName;
	}

	public void setStacksByName(HashMap<String, ArrayStack<Object>> stacksByName) {
		this.stacksByName = stacksByName;
	}
