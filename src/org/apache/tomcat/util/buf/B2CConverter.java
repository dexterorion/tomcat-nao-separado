...
public class B2CConverter {
	...
	private static final StringManager3 sm = StringManager3
			.getManager(Constants32.getPackage());
	...
	public static Map<String, Charset> getEncodingtocharsetcache() {
		return encodingToCharsetCache;
	}
	...
	public static int getLeftoverSize() {
	...
	public ByteBuffer getLeftovers() {
		return leftovers;
	}
