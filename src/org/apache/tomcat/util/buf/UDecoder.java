...
public final class UDecoder {
    ...
    private static final IOException EXCEPTION_EOF = new UDecoderDecodeException("EOF");

    /** %xx with not-hex digit */
    private static final IOException EXCEPTION_NOT_HEX_DIGIT = new UDecoderDecodeException(
            "isHexDigit");

    /** %-encoded slash is forbidden in resource path */
    private static final IOException EXCEPTION_SLASH = new UDecoderDecodeException(
            "noSlash");
        ...
        throws IOException
    {
        ...
        case 1:
            ...
            try {
                ...
                throw new UDecoderDecodeException(ex.getMessage());
            }
            break;
        case 3:
