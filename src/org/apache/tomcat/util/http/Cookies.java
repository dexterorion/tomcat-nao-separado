...
public final class Cookies {
    ...
    private static final StringManager3 sm =
            StringManager3.getManager("org.apache.tomcat.util.http");
    ...
    public  void processCookies( MimeHeaders headers ) {
        ...
        while( pos>=0 ) {
            ...
            if( cookieValue.getType() != MessageBytes.gettBytes() ) {
        ...
        while (pos < end) {
            ...
            while (pos < end &&
                   (CookieSupport.isHttpSeparator((char) bytes[pos]) &&
                           !CookieSupport.isAllowHttpSeparatorsInV0() ||
            ...
            if (pos < (end - 1) && bytes[pos] == '=') {
                ...
                default:
                    if (version == 0 &&
                                ...
                                CookieSupport.isAllowHttpSeparatorsInV0() ||
                            !CookieSupport.isHttpSeparator((char)bytes[pos]) ||
                            bytes[pos] == '=' && CookieSupport.isAllowEqualsInValue()) {
                        // Token
                        valueStart=pos;
            ...
            if (isSpecial) {
                ...
                if (valueStart == -1 && !CookieSupport.isAllowNameOnly()) {
        ...
        while (pos < end &&
                (!CookieSupport.isHttpSeparator((char)bytes[pos]) ||
                 version == 0 &&
                        ...
                        !CookieSupport.isV0Separator((char)bytes[pos]) ||
                 !isName && bytes[pos] == '=' &&
                         CookieSupport.isAllowEqualsInValue())) {
            pos++;
        }
