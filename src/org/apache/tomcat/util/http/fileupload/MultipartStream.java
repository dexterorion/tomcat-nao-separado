...
public class MultipartStream {
	 ...
	 */
	private final MultipartStreamProgressNotifier notifier;
	...
	public MultipartStream(InputStream input, byte[] boundary, int bufSize,
			MultipartStreamProgressNotifier pNotifier) {
		this.input = input;
	 ...
	 *             syntax.
	 */
	public boolean readBoundary() throws FileUploadBaseFileUploadIOException,
			MultipartStreamMalformedStreamException {
		...
		try {
			...
			if (arrayequals(marker, STREAM_TERMINATOR, 2)) {
				...
				throw new MultipartStreamMalformedStreamException(
	...
	public void setBoundary(byte[] boundary)
			throws MultipartStreamIllegalBoundaryException {
		if (boundary.length != boundaryLength - BOUNDARY_PREFIX.length) {
			throw new MultipartStreamIllegalBoundaryException(
	 ...
	 */
	public String readHeaders() throws FileUploadBaseFileUploadIOException,
			MultipartStreamMalformedStreamException {
		int i = 0;
		byte b;
	...
	public int readBodyData(OutputStream output)
			throws MultipartStreamMalformedStreamException, IOException {
	 ...
	 */
	public MultipartStreamItemInputStream newInputStream() {
		return new MultipartStreamItemInputStream(this);
	}
	...
	public boolean skipPreamble() throws IOException {
		...
		try {
			...
			// encapsulation.
			return readBoundary();
		} catch (MultipartStreamMalformedStreamException e) {
			return false;
		} finally {
			// Restore delimiter.
	...
	public int getKeepRegion() {
		return keepRegion;
	}

	public void setKeepRegion(int keepRegion) {
		this.keepRegion = keepRegion;
	}
	...
	public static byte getDash() {
		return DASH;
	}

	public static int getHeaderPartSizeMax() {
		return HEADER_PART_SIZE_MAX;
	}

	public static int getDefaultBufsize() {
		return DEFAULT_BUFSIZE;
	}

	public static byte[] getHeaderSeparator() {
		return HEADER_SEPARATOR;
	}

	public static byte[] getFieldSeparator() {
		return FIELD_SEPARATOR;
	}

	public static byte[] getStreamTerminator() {
		return STREAM_TERMINATOR;
	}

	public static byte[] getBoundaryPrefix() {
