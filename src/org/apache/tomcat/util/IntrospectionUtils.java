...
public final class IntrospectionUtils {
    ...
    public static void setAttribute(Object proxy, String n, Object v)
            throws Exception {
        if (proxy instanceof IntrospectionUtilsAttributeHolder) {
            ((IntrospectionUtilsAttributeHolder) proxy).setAttribute(n, v);
            return;
        }
    ...
    public static boolean setProperty(Object o, String name, String value,
        ...
        try {
            ...
            ExceptionUtils2.handleThrowable(ie.getCause());
    ...
    public static String replaceProperties(String value,
            Hashtable<Object,Object> staticProp, IntrospectionUtilsPropertySource dynamicProp[]) {
        if (value.indexOf("$") < 0) {
            return value;
        }
    ...
    private static Hashtable<Class<?>,Method[]> objectMethods =
