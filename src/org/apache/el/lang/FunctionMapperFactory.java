 ...
 */
public class FunctionMapperFactory extends FunctionMapper2 {

    private FunctionMapperImpl memento = null;
    private FunctionMapper2 target;

    public FunctionMapperFactory(FunctionMapper2 mapper) {
        if (mapper == null) {
