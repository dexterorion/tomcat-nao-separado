...
public final class AstDynamicExpression extends SimpleNode {
    ...
    public Class<?> getType(EvaluationContext ctx)
            throws ELException {
        return this.getChildren()[0].getType(ctx);
    }

    @Override
    public Object getValue(EvaluationContext ctx)
            throws ELException {
        return this.getChildren()[0].getValue(ctx);
    }

    @Override
    public boolean isReadOnly(EvaluationContext ctx)
            throws ELException {
        return this.getChildren()[0].isReadOnly(ctx);
    }

    @Override
    public void setValue(EvaluationContext ctx, Object value)
            throws ELException {
        this.getChildren()[0].setValue(ctx, value);
    }
}
