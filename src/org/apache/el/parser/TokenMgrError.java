...
public class TokenMgrError extends Error {
	 ...
	 * manager.
	 */
	private static final int STATIC_LEXER_ERROR = 1;

	/**
	 * Tried to change to an invalid lexical state.
	 */
	private static final int INVALID_LEXICAL_STATE = 2;

	/**
	 * Detected (and bailed out of) an infinite loop in the token manager.
	 */
	private static final int LOOP_DETECTED = 3;
	...
	public static int getLexicalError() {
		return LEXICAL_ERROR;
	}

	public static int getStaticLexerError() {
		return STATIC_LEXER_ERROR;
	}

	public static int getInvalidLexicalState() {
		return INVALID_LEXICAL_STATE;
	}

	public static int getLoopDetected() {
