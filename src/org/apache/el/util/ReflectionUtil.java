...
public class ReflectionUtil {
    ...
    public static Method getMethod(Object base, Object property,
        ...
        Map<Method,ReflectionUtilMatchResult> candidates = new HashMap<Method,ReflectionUtilMatchResult>();
        ...
        for (Method m : methods) {
            ...
            candidates.put(m, new ReflectionUtilMatchResult(
                    exactMatch, assignableMatch, coercibleMatch, m.isBridge()));
        }

        // Look for the method that has the highest number of parameters where
        // the type matches exactly
        ReflectionUtilMatchResult bestMatch = new ReflectionUtilMatchResult(0, 0, 0, false);
        Method match = null;
        boolean multiple = false;
        for (Map.Entry<Method, ReflectionUtilMatchResult> entry : candidates.entrySet()) {
