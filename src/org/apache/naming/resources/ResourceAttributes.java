...
public class ResourceAttributes implements Attributes {
	 ...
	 * Creation date.
	 */
	private static final String ALTERNATE_CREATION_DATE = "creation-date";

	/**
	 * Last modification date.
	 */
	private static final String LAST_MODIFIED = "getlastmodified";

	/**
	 * Last modification date.
	 */
	private static final String ALTERNATE_LAST_MODIFIED = "last-modified";
	 ...
	 * Type.
	 */
	private static final String ALTERNATE_TYPE = "content-type";
	 ...
	 * Content length.
	 */
	private static final String ALTERNATE_CONTENT_LENGTH = "content-length";

	/**
	 * ETag.
	 */
	private static final String ETAG = "getetag";

	/**
	 * ETag.
	 */
	private static final String ALTERNATE_ETAG = "etag";
	...
	public void setWeakETag(String weakETag) {
	...
	public void setStrongETag(String strongETag) {
	...
	public static String getAlternateCreationDate() {
		return ALTERNATE_CREATION_DATE;
	}

	public static String getAlternateLastModified() {
		return ALTERNATE_LAST_MODIFIED;
	}
	...
	public static String getAlternateType() {
		return ALTERNATE_TYPE;
	}

	public static String getAlternateContentLength() {
		return ALTERNATE_CONTENT_LENGTH;
	}
	...
	public static String getAlternateEtag() {
	...
	public static String getContentLengthStatic(){
		return CONTENT_LENGTH;
	}
	
	public static String getLastModifiedStatic(){
