...
public class DirContextURLStreamHandler extends URLStreamHandler {
    ...
    public static void setProtocolHandler() {
        String value = System.getProperty(Constants31.getProtocolHandlerVariable());
        if (value == null) {
            value = Constants31.getPackage();
            System.setProperty(Constants31.getProtocolHandlerVariable(), value);
        } else if (value.indexOf(Constants31.getPackage()) == -1) {
            value += "|" + Constants31.getPackage();
            System.setProperty(Constants31.getProtocolHandlerVariable(), value);
        }
    }
