...
public class DirContextURLStreamHandlerFactory
    ...
    public static void addUserFactory(URLStreamHandlerFactory factory) {
        getInstanceData().getUserFactoriesData().add(factory);
    }
    ...
    public URLStreamHandler createURLStreamHandler(String protocol) {
        if (protocol.equals("jndi")) {
            ...
            for (URLStreamHandlerFactory factory : getUserFactoriesData()) {
	...
	public static DirContextURLStreamHandlerFactory getInstanceData() {
		return instance;
	}

	public static void setInstanceData(DirContextURLStreamHandlerFactory instance) {
		DirContextURLStreamHandlerFactory.instance = instance;
	}

	public List<URLStreamHandlerFactory> getUserFactoriesData() {
		return userFactories;
	}

	public void setUserFactoriesData(List<URLStreamHandlerFactory> userFactories) {
