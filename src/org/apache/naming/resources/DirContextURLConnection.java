...
import org.apache.naming.Constants29;
...
public class DirContextURLConnection extends URLConnection {
    ...
    public DirContextURLConnection(DirContext context, URL url) {
        ...
        if (Constants29.isSecurityEnabled()) {
    ...
    public int getContentLength() {
        return getHeaderFieldInt(ResourceAttributes.getContentLengthStatic(), -1);
    }
    ...
    public String getContentType() {
        return getHeaderField(ResourceAttributes.getContentType());
    }
    ...
    public long getLastModified() {
        ...
        Attribute lastModified =
            attributes.get(ResourceAttributes.getLastModifiedStatic());
