...
public class JspConfig {
    ...
    private Vector<JspConfigJspPropertyGroup> jspProperties = null;
    ...
    private JspConfigJspProperty defaultJspProperty;
    ...
    private void processWebDotXml() throws JasperException {
        ...
        try {
            webXml = new WebXml2(ctxt);
            
            boolean validate = Boolean.parseBoolean(
                    ctxt.getInitParameter(Constants28.getXmlValidationInitParam()));
            String blockExternalString =
                    ctxt.getInitParameter(Constants28.getXmlBlockExternalInitParam());
            ...
            jspProperties = new Vector<JspConfigJspPropertyGroup>();
            ...
            while (jspPropertyList.hasNext()) {
                ...
                for( int p = 0; p < urlPatterns.size(); p++ ) {
                    ...
                    JspConfigJspProperty property = new JspConfigJspProperty(isXml,
                            elIgnored,
                            scriptingInvalid,
                            pageEncoding,
                            includePrelude,
                    ...
                    JspConfigJspPropertyGroup propertyGroup =
                        new JspConfigJspPropertyGroup(path, extension, property);
    ...
    private void init() throws JasperException {
        ...
        if (!initialized) {
            synchronized (this) {
                if (!initialized) {
                    processWebDotXml();
                    defaultJspProperty = new JspConfigJspProperty(defaultIsXml,
                            defaultIsELIgnored,
     ...
     */
    private JspConfigJspPropertyGroup selectProperty(JspConfigJspPropertyGroup prev,
    		JspConfigJspPropertyGroup curr) {
        if (prev == null) {
            return curr;
        }
     ...
     */
    public JspConfigJspProperty findJspProperty(String uri) throws JasperException {
        ...
        JspConfigJspPropertyGroup isXmlMatch = null;
        JspConfigJspPropertyGroup elIgnoredMatch = null;
        JspConfigJspPropertyGroup scriptingInvalidMatch = null;
        JspConfigJspPropertyGroup pageEncodingMatch = null;
        JspConfigJspPropertyGroup deferedSyntaxAllowedAsLiteralMatch = null;
        JspConfigJspPropertyGroup trimDirectiveWhitespacesMatch = null;
        JspConfigJspPropertyGroup defaultContentTypeMatch = null;
        JspConfigJspPropertyGroup bufferMatch = null;
        JspConfigJspPropertyGroup errorOnUndeclaredNamespaceMatch = null;

        Iterator<JspConfigJspPropertyGroup> iter = jspProperties.iterator();
        while (iter.hasNext()) {

        	JspConfigJspPropertyGroup jpg = iter.next();
        	JspConfigJspProperty jp = jpg.getJspProperty();
        ...
        return new JspConfigJspProperty(isXml, isELIgnored, isScriptingInvalid,
