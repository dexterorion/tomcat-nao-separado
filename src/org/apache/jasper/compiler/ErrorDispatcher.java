...
public class ErrorDispatcher {
    ...
    private ErrorHandler2 errHandler;
    ...
    private static JavacErrorDetail[] parseJavacMessage(
                                String errMsg, String fname, NodeNodes page)
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (errMsgBuf != null) {
                ...
                errMsgBuf.append(Constants28.getNewline());
            }
        }
    ...
    public static JavacErrorDetail createJavacError(String fname,
            NodeNodes page, StringBuilder errMsgBuf, int lineNum)
    throws JasperException {
    ...
    public static JavacErrorDetail createJavacError(String fname,
        ...
        ErrorDispatcherErrorVisitor errVisitor = new ErrorDispatcherErrorVisitor(lineNum);
        ...
        if ((errNode != null) && (errNode.getStart() != null)) {
            ...
            if (errVisitor.getJspSourceNode() instanceof NodeScriptlet) {
