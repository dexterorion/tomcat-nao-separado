 ...
 */
public class WebXml2 {
    private static final String FILE_PROTOCOL = "file:";
    private static final String WEB_XML = "/WEB-INF/web.xml";

    private final Log log = LogFactory.getLog(WebXml2.class);
            
    private InputStream stream;
    private InputSource source;
    private String systemId;

    public WebXml2(ServletContext ctxt) throws IOException {
        ...
        if (webXml != null) {
            ...
            systemId = Constants35.getMergedWebXml();
        }
