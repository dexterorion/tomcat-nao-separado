...
public class ParserController implements TagConstants {
     ...
     * Constructor
     */
    public ParserController(JspCompilationContext ctxt, Compiler2 compiler) {
        this.ctxt = ctxt; 
     ...
     */
    public NodeNodes parse(String inFileName)
     ...
     * @param inFileName The path to the JSP page or tag file to be parsed.
     */
    public NodeNodes parseDirectives(String inFileName)
    throws FileNotFoundException, JasperException, IOException {
        // If we're parsing a packaged tag file or a resource included by it
        // (using an include directive), ctxt.getTagFileJar() returns the 
        // JAR file from which to read the tag file or included resource,
     ...
     */
    public NodeNodes parse(String inFileName, Node parent,
     ...
     */
    public NodeNodes parseTagFileDirectives(String inFileName,
            JarResource jarResource)
            throws FileNotFoundException, JasperException, IOException {
        ...
        isTagFile = true;
        directiveOnly = true;
        NodeNodes page = doParse(inFileName, null, jarResource);
     ...
     */
    private NodeNodes doParse(String inFileName,
            Node parent,
            JarResource jarResource)
    throws FileNotFoundException, JasperException, IOException {

        NodeNodes parsedPage = null;
    ...
    throws JasperException, IOException {
        ...
        JspConfig jspConfig = ctxt.getOptions().getJspConfig();
        JspConfigJspProperty jspProperty = jspConfig.findJspProperty(
                absFileName);
