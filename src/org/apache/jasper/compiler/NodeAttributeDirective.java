...
public class NodeAttributeDirective extends Node {

    public NodeAttributeDirective(Attributes attrs, Mark start, Node parent) {
        this(JSP_ATTRIBUTE_DIRECTIVE_ACTION, attrs, null, null, start,
                parent);
    }

    public NodeAttributeDirective(String qName, Attributes attrs,
