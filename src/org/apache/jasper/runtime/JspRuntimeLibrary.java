...
public class JspRuntimeLibrary {
    ...
    public static Throwable getThrowable(ServletRequest request) {
        ...
        if (error == null) {
            error = (Throwable) request.getAttribute(PageContext.getExceptionVariable());
            if (error != null) {
                /*
   ...
   // __begin convertMethod
                                        ...
                                        throws JasperException
    {
        if( Constants28.isSecurityEnabled() ) {
            try {
                JspRuntimeLibraryPrivilegedIntrospectHelper dp =
                    new JspRuntimeLibraryPrivilegedIntrospectHelper(
    ...
    static void internalIntrospecthelper(Object bean, String prop,
                                        String value, ServletRequest request,
                                        String param, boolean ignoreMethodNF) 
                                        throws JasperException
    {
