...
public class TagHandlerPool {
	...
	private static final String OPTION_TAGPOOL = "tagpoolClassName";
	private static final String OPTION_MAXSIZE = "tagpoolMaxSize";
	...
	public static String getOptionTagpool() {
		return OPTION_TAGPOOL;
	}

	public static String getOptionMaxsize() {
		return OPTION_MAXSIZE;
	}
