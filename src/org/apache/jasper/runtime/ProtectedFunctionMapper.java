 ...
 */
public final class ProtectedFunctionMapper extends FunctionMapper2
     ...
     */
    public ProtectedFunctionMapper() {
    }
    ...
    public static ProtectedFunctionMapper getInstance() {
        ...
        funcMapper.setFnmapData(new HashMap<String,Method>());
        return funcMapper;
    }
    ...
    public void mapFunction(String fnQName, final Class<?> c,
        ...
        this.getFnmapData().put(fnQName, method);
    }
    ...
    public static ProtectedFunctionMapper getMapForFunction(String fnQName,
        ...
        funcMapper.setTheMethodData(method);
        return funcMapper;
    }
    ...
    public Method resolveFunction(String prefix, String localName) {
        if (this.getFnmapData() != null) {
            return this.getFnmapData().get(prefix + ":" + localName);
        }
        return getTheMethodData();
    }

	public HashMap<String,Method> getFnmapData() {
		return fnmap;
	}

	public void setFnmapData(HashMap<String,Method> fnmap) {
		this.fnmap = fnmap;
	}

	public Method getTheMethodData() {
		return theMethod;
	}

	public void setTheMethodData(Method theMethod) {
