...
public class JspWriterImpl extends JspWriter {
    ...
    public JspWriterImpl() {
        super( Constants28.getDefaultBufferSize(), true );
    }
    ...
    public JspWriterImpl(ServletResponse response) {
        this(response, Constants28.getDefaultBufferSize(), true);
    }
    ...
    public void init( ServletResponse response, int sz, boolean autoFlush ) {
        this.response= response;
    ...
    throws IOException 
    {
        ...
        int b = off, t = off + len;
        while (b < t) {
            int d = min(getBufferSize() - nextChar, t - b);
