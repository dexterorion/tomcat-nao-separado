...
public class JspServlet extends HttpServlet implements PeriodicEventListener {
     ...
     */
    public boolean preCompile(HttpServletRequest request) throws ServletException {

        String queryString = request.getQueryString();
        if (queryString == null) {
            return (false);
        }
        int start = queryString.indexOf(Constants28.getPrecompile());
        if (start < 0) {
            return (false);
        }
        queryString =
            queryString.substring(start + Constants28.getPrecompile().length());
        ...
        if (value.equals("true")) {
            ...
            throw new ServletException("Cannot have request parameter " +
                                       Constants28.getPrecompile() + " set to " +
                                       value);
        }
    ...
    public void service (HttpServletRequest request, 
        ...
        if (jspUri == null) {
            ...
            String jspFile = (String) request.getAttribute(Constants28.getJspFile());
            if (jspFile != null) {
                jspUri = jspFile;
                request.removeAttribute(Constants28.getJspFile());
            }
        }
        if (jspUri == null) {
            /*
    ...
    private void handleMissingResource(HttpServletRequest request,
        ...
        if (includeRequestUri != null) {
            ...
            throw new ServletException(SecurityUtil2.filter(msg));
        } else {
            try {
