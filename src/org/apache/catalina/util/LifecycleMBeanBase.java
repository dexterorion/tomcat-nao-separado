...
public abstract class LifecycleMBeanBase extends LifecycleBase implements
	...
	private static StringManager3 sm = StringManager3
	...
	public final String getDomain() {
		...
		if (domain == null) {
			domain = Globals.getDefaultMbeanDomain();
		}
	...
	protected final ObjectName register(Object obj,
		...
		try {
			...
			Registry2.getRegistry(null, null).registerComponent(obj, on, null);
	...
	public static void setSm(StringManager3 sm) {
		LifecycleMBeanBase.sm = sm;
	}
