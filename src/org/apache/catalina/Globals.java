...
public final class Globals {
     ...
     */
    private static final String ALT_DD_ATTR =
     ...
     * if any.
     */
    private static final String CERTIFICATES_ATTR =
     ...
     * java.lang.String).
     */
    private static final String CIPHER_SUITE_ATTR =
     ...
     */
    private static final String DISPATCHER_TYPE_ATTR =
     ...
     */
    private static final String DISPATCHER_REQUEST_PATH_ATTR =
     ...
     */
    private static final String RESOURCES_ATTR =
     ...
     */
    private static final String KEY_SIZE_ATTR =
     ...
     */
    private static final String SSL_SESSION_ID_ATTR =
     ...
     */
    @Deprecated
    private static final String SSL_SESSION_ID_TOMCAT_ATTR =
     ...
     */
    private static final String SSL_SESSION_MGR_ATTR =
     ...
     */
    @Deprecated
    private static final String MBEAN_REGISTRY_ATTR =
     ...
     */
    @Deprecated
    private static final String MBEAN_SERVER_ATTR =
     ...
     */
    private static final String NAMED_DISPATCHER_ATTR =
     ...
     */
    private static final String SSI_FLAG_ATTR =
     ...
     */
    private static final String SUBJECT_ATTR =
        "javax.security.auth.subject";


    private static final String GSS_CREDENTIAL_ATTR =
     ...
     */
    @Deprecated
    private static final String TOMCAT_CONNECTOR_ATTR_PREFIX =
        "org.apache.tomcat.";
    ...
    private static final String SENDFILE_FILE_START_ATTR =
            Constants24.getSendfileFileStartAttr();
    ...
    private static final String SENDFILE_FILE_END_ATTR =
            Constants24.getSendfileFileEndAttr();
    ...
    private static final String REMOTE_ADDR_ATTRIBUTE =
            Constants24.getRemoteAddrAttribute();


    /**
     *
     */
    private static final String ASYNC_SUPPORTED_ATTR =
     ...
     */
    private static final String DEFAULT_MBEAN_DOMAIN = "Catalina";
     ...
     */
    private static final String JASPER_XML_VALIDATION_TLD_INIT_PARAM =
     ...
     * This must be kept in sync with org.apache.jasper.Constants
     */
    private static final String JASPER_XML_VALIDATION_INIT_PARAM =
     ...
     * This must be kept in sync with org.apache.jasper.Constants
     */
    private static final String JASPER_XML_BLOCK_EXTERNAL_INIT_PARAM =
	...
	public static boolean isOracleJvm() {
		return IS_ORACLE_JVM;
	}

	public static String getJasperXmlBlockExternalInitParam() {
		return JASPER_XML_BLOCK_EXTERNAL_INIT_PARAM;
	}

	public static String getJasperXmlValidationInitParam() {
		return JASPER_XML_VALIDATION_INIT_PARAM;
	}

	public static String getJasperXmlValidationTldInitParam() {
		return JASPER_XML_VALIDATION_TLD_INIT_PARAM;
	}

	public static String getCatalinaBaseProp() {
		return CATALINA_BASE_PROP;
	}

	public static String getCatalinaHomeProp() {
		return CATALINA_HOME_PROP;
	}

	public static String getDefaultMbeanDomain() {
		return DEFAULT_MBEAN_DOMAIN;
	}
	...
	public static boolean isStrictServletCompliance() {
		return STRICT_SERVLET_COMPLIANCE;
	}

	public static String getParameterParseFailedAttr() {
		return PARAMETER_PARSE_FAILED_ATTR;
	}

	public static String getAsyncSupportedAttr() {
		return ASYNC_SUPPORTED_ATTR;
	}
	...
	public static String getTomcatConnectorAttrPrefix() {
		return TOMCAT_CONNECTOR_ATTR_PREFIX;
	}

	public static String getGssCredentialAttr() {
		return GSS_CREDENTIAL_ATTR;
	}

	public static String getSubjectAttr() {
		return SUBJECT_ATTR;
	}

	public static String getSsiFlagAttr() {
		return SSI_FLAG_ATTR;
	}

	public static String getNamedDispatcherAttr() {
		return NAMED_DISPATCHER_ATTR;
	}

	public static String getMbeanServerAttr() {
		return MBEAN_SERVER_ATTR;
	}

	public static String getMbeanRegistryAttr() {
		return MBEAN_REGISTRY_ATTR;
	}

	public static String getSslSessionMgrAttr() {
		return SSL_SESSION_MGR_ATTR;
	}

	public static String getSslSessionIdTomcatAttr() {
		return SSL_SESSION_ID_TOMCAT_ATTR;
	}

	public static String getSslSessionIdAttr() {
		return SSL_SESSION_ID_ATTR;
	}

	public static String getKeySizeAttr() {
		return KEY_SIZE_ATTR;
	}

	public static String getClassPathAttr() {
		return CLASS_PATH_ATTR;
	}

	public static String getResourcesAttr() {
		return RESOURCES_ATTR;
	}

	public static String getDispatcherRequestPathAttr() {
		return DISPATCHER_REQUEST_PATH_ATTR;
	}

	public static String getDispatcherTypeAttr() {
		return DISPATCHER_TYPE_ATTR;
	}

	public static String getCipherSuiteAttr() {
		return CIPHER_SUITE_ATTR;
	}

	public static String getCertificatesAttr() {
		return CERTIFICATES_ATTR;
	}

	public static String getAltDdAttr() {
		return ALT_DD_ATTR;
	}
}
