...
public class NamingResourcesMBean extends BaseModelMBean {
     ...
     */
    private Registry2 registry = MBeanUtils.createRegistry();
    ...
    public String[] getEnvironments() {
        ContextEnvironment[] envs = 
                            ((NamingResources)this.getResource()).findEnvironments();
    ...
    public String[] getResources() {
        ...
        ContextResource[] resources = 
                            ((NamingResources)this.getResource()).findResources();
        ArrayList<String> results = new ArrayList<String>();
    ...
    public String[] getResourceLinks() {
        ...
        ContextResourceLink[] resourceLinks = 
                            ((NamingResources)this.getResource()).findResourceLinks();
        ArrayList<String> results = new ArrayList<String>();
    ...
    public String addEnvironment(String envName, String type, String value) 
        ...
        NamingResources nresources = (NamingResources) this.getResource();
        if (nresources == null) {
            return null;
        }
