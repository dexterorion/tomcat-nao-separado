...
public class MBeanUtils {
     ...
     */
    private static Registry2 registry = createRegistry();
     ...
     * @exception Exception if an MBean cannot be created or registered
     */
    public static DynamicMBean createMBean(Group group)
        throws Exception {
     ...
     */
    @Deprecated
    public static DynamicMBean createMBean(Loader loader)
        throws Exception {
     ...
     */
    @Deprecated
    public static DynamicMBean createMBean(MBeanFactory factory)
        throws Exception {
     ...
     */
    @Deprecated
    public static DynamicMBean createMBean(NamingResources resource)
        throws Exception {
     ...
     * @exception Exception if an MBean cannot be created or registered
     */
    public static DynamicMBean createMBean(Role role)
        throws Exception {
     ...
     * @exception Exception if an MBean cannot be created or registered
     */
    public static DynamicMBean createMBean(User user)
        throws Exception {
     ...
     * @exception Exception if an MBean cannot be created or registered
     */
    public static DynamicMBean createMBean(UserDatabase userDatabase)
        throws Exception {
     ...
     */
    @Deprecated
    public static ObjectName createObjectName(String domain, Engine engine)
        throws MalformedObjectNameException {
     ...
     */
    @Deprecated
    public static ObjectName createObjectName(String domain, Server server)
        throws MalformedObjectNameException {
     ...
     */
    @Deprecated
    private static Hashtable<String,int[]> seq = new Hashtable<String,int[]>();
    /*
     * @deprecated  Unused. Will be removed in Tomcat 8.0.x
     */
    @Deprecated
     ...
     */
    public static synchronized Registry2 createRegistry() {

        if (registry == null) {
            registry = Registry2.getRegistry(null, null);
    ...
    public static synchronized MBeanServer createServer() {
        ...
        if (mserver == null) {
            mserver = Registry2.getRegistry(null, null).getMBeanServer();
        }
        return (mserver);
   ...
   /**
     ...
     * @exception Exception if an MBean cannot be deregistered
     */
    public static void destroyMBeanUserDatabase(String userDatabase)
        throws Exception {
