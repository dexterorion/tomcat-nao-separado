...
public class DataSourceRealm
     ...
     * Descriptive information about this Realm implementation.
     */
    private static final String name = "DataSourceRealm";
    ...
    protected Principal authenticate(Connection dbConnection,
        ...
        if (validated) {
            if (getContainerLog().isTraceEnabled())
                getContainerLog().trace(
                    getSm().getString("dataSourceRealm.authenticateSuccess",
                                 username));
        } else {
            if (getContainerLog().isTraceEnabled())
                getContainerLog().trace(
                    getSm().getString("dataSourceRealm.authenticateFailure",
                                 username));
            return (null);
        }
    ...
    protected void close(Connection dbConnection) {
        ...
        try {
            ...
            getContainerLog().error("Exception committing connection before closing:", e);
        }
        ...
        try {
            ...
            getContainerLog().error(getSm().getString("dataSourceRealm.close"), e); // Just log it here
        }
    ...
    protected Connection open() {
        ...
        return dataSource.getConnection();
            ...
            getContainerLog().error(getSm().getString("dataSourceRealm.exception"), e);
        }  
        return null;
    }
    ...
    protected String getPassword(Connection dbConnection, 
        ...
        try {
            ...
            getContainerLog().error(
                    getSm().getString("dataSourceRealm.getPassword.exception",
                                 username), e);
        } finally {
            try {
                if (rs != null) {
    ...
    protected ArrayList<String> getRoles(Connection dbConnection,
        ...
        if (getAllRolesModeVariable() != RealmBaseAllRolesMode.getStrictMode() && !isRoleStoreDefined()) {
        ...
        try {
            ...
            getContainerLog().error(
                getSm().getString("dataSourceRealm.getRoles.exception", username), e);
        }
        finally {
            try {
                if (rs != null) {
                ...
                if (stmt != null) {
                    ...
                    getContainerLog().error(
                        getSm().getString("dataSourceRealm.getRoles.exception",
                                     username), e);
            }
        }
