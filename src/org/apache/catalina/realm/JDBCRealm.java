...
public class JDBCRealm
    ...
    public synchronized Principal authenticate(String username, String credentials) {
        ...
        while (numberOfTries>0) {
            try {
                ...
                getContainerLog().error(getSm().getString("jdbcRealm.exception"), e);
    ...
    public synchronized Principal authenticate(Connection dbConnection,
        ...
        if (validated) {
            if (getContainerLog().isTraceEnabled())
                getContainerLog().trace(getSm().getString("jdbcRealm.authenticateSuccess",
                                                username));
        } else {
            if (getContainerLog().isTraceEnabled())
                getContainerLog().trace(getSm().getString("jdbcRealm.authenticateFailure",
                                                username));
            return (null);
        }
    ...
    protected void close(Connection dbConnection) {
        ...
        try {
            ...
            getContainerLog().warn(getSm().getString("jdbcRealm.close"), e); // Just log it here
        } finally {
    ...
    protected PreparedStatement credentials(Connection dbConnection,
        ...
        if (preparedCredentials == null) {
            ...
            if(getContainerLog().isDebugEnabled()) {
                getContainerLog().debug("credentials query: " + sb.toString());
            }
            ...
            try {
                ...
                if (rs != null) {
                    try {
                        ...
                        getContainerLog().warn(getSm().getString(
                ...
                try {
                    ...
                    if (rs!=null) {
                        try {
                            ...
                            getContainerLog().warn(getSm().getString("jdbcRealm.abnormalCloseResultSet"));
                        }
                    }
                    dbConnection.commit();
                }
    ...
    protected Connection open() throws SQLException {
        ...
        if (dbConnection == null) {
            throw new SQLException(getSm().getString(
    ...
    protected void startInternal() throws LifecycleException {
        ...
        try {
            ...
            getContainerLog().error(getSm().getString("jdbcRealm.open"), e);
        }
