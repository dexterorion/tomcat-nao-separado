...
public class UserDatabaseRealm extends RealmBase {
	 ...
	 */
	private static final String info = "org.apache.catalina.realm.UserDatabaseRealm/1.0";

	/**
	 * Descriptive information about this Realm implementation.
	 */
	private static final String name = "UserDatabaseRealm";

	/**
	 * The global JNDI name of the <code>UserDatabase</code> resource we will be
	 * utilizing.
	 */
	private String resourceName = "UserDatabase";
	...
	protected void startInternal() throws LifecycleException {
		...
		try {
			...
			getContainerLog()
					.error(getSm().getString("userDatabaseRealm.lookup",
							resourceName), e);
			database = null;
		}
		if (database == null) {
			throw new LifecycleException(getSm().getString(
