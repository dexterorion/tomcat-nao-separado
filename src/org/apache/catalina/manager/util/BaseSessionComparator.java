 ...
 */
public abstract class BaseSessionComparator<T> implements Comparator<Session2> {
    ...
    public abstract Comparable<T> getComparableObject(Session2 session);
    ...
    @Override
    public final int compare(Session2 s1, Session2 s2) {
