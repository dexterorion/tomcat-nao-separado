...
public class SessionUtils {
     ...
     * @return String
     */
    public static Locale guessLocaleFromSession(final Session2 in_session) {
     ...
     * @return Object
     */
    public static Object guessUserFromSession(final Session2 in_session) {
        if (null == in_session) {
            return null;
        }
    ...
    public static long getUsedTimeForSession(Session2 in_session) {
        try {
    ...
    public static long getTTLForSession(Session2 in_session) {
        try {
    ...
    public static long getInactiveTimeForSession(Session2 in_session) {
        try {
