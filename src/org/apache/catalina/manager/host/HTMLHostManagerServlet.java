...
import org.apache.catalina.manager.Constants10;
...
public final class HTMLHostManagerServlet extends HostManagerServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        response.setContentType("text/html; charset=" + Constants11.getCharset());
     ...
     * @param name host name
     */
    protected String remove(String name, StringManager3 smClient) {
     ...
     * @param name Host name
     */
    protected String start(String name, StringManager3 smClient) {
     ...
     * @param name Host name
     */
    protected String stop(String name, StringManager3 smClient) {
    ...
    public void list(HttpServletRequest request,
        ...
        if (getDebug() >= 1) {
            log(getSm().getString("hostManagerServlet.list", getEngine().getName()));
        }
        ...
        writer.print(MessageFormat.format
                     (Constants11.getBodyHeaderSection(), args));
        ...
        writer.print(MessageFormat.format(Constants11.getMessageSection(), args));
        ...
        writer.print(MessageFormat.format(Constants11.getManagerSection(), args));
        ...
        Container[] children = getEngine().findChildren();
        ...
        while (iterator.hasNext()) {
            ...
            Host host = (Host) getEngine().findChild(hostName);
        ...
        writer.print(MessageFormat.format
                     (Constants11.getServerHeaderSection(), args));
        ...
        writer.print(MessageFormat.format(Constants11.getServerRowSection(), args));

        // HTML Tail Section
        writer.print(Constants11.getHtmlTailSection());
    ...
    private static final String MANAGER_HOST_ROW_BUTTON_SECTION =
        " <td class=\"row-left\">\n" +
        "  <small>\n" +
        getSm().getString("htmlHostManagerServlet.hostThis") +
        "  </small>\n" +
        " </td>\n" +
        "</tr>\n";
