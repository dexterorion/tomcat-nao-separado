...
public class SSIMediator {
	private static final String DEFAULT_CONFIG_ERR_MSG = "[an error occurred while processing this directive]";
	private static final String DEFAULT_CONFIG_TIME_FMT = "%A, %d-%b-%Y %T %Z";
	private static final String DEFAULT_CONFIG_SIZE_FMT = "abbrev";
	private static URLEncoder urlEncoder;
	private String configErrMsg = DEFAULT_CONFIG_ERR_MSG;
	private String configTimeFmt = DEFAULT_CONFIG_TIME_FMT;
	private String configSizeFmt = DEFAULT_CONFIG_SIZE_FMT;
	private String className = getClass().getName();
	private SSIExternalResolver ssiExternalResolver;
	private long lastModifiedDate;
	private int debug;
	private Strftime strftime;
	private SSIConditionalState conditionalState = new SSIConditionalState();
    static {
