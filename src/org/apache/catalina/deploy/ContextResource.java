...
public class ContextResource extends ResourceBase {
    ...
    public boolean getSingleton() {
        return isSingletonData();
    }
    
    public void setSingleton(boolean singleton) {
        this.setSingletonData(singleton);
    }
    ...
    public String getCloseMethod() {
        return getCloseMethodData();
    }

    public void setCloseMethod(String closeMethod) {
        this.setCloseMethodData(closeMethod);
    }
    ...
    public String toString() {
        ...
        if (getAuthData() != null) {
            sb.append(", auth=");
            sb.append(getAuthData());
        }
        if (getScopeData() != null) {
            sb.append(", scope=");
            sb.append(getScopeData());
        }
        sb.append("]");
        return (sb.toString());
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAuthData() == null) ? 0 : getAuthData().hashCode());
        result = prime * result +
                ((getCloseMethodData() == null) ? 0 : getCloseMethodData().hashCode());
        result = prime * result + ((getScopeData() == null) ? 0 : getScopeData().hashCode());
        result = prime * result + (isSingletonData() ? 1231 : 1237);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getAuthData() == null) {
            if (other.getAuthData() != null) {
                return false;
            }
        } else if (!getAuthData().equals(other.getAuthData())) {
            return false;
        }
        if (getCloseMethodData() == null) {
            if (other.getCloseMethodData() != null) {
                return false;
            }
        } else if (!getCloseMethodData().equals(other.getCloseMethodData())) {
            return false;
        }
        if (getScopeData() == null) {
            if (other.getScopeData() != null) {
                return false;
            }
        } else if (!getScopeData().equals(other.getScopeData())) {
            return false;
        }
        if (isSingletonData() != other.isSingletonData()) {
            return false;
        }
        return true;
    }
	...
	private void setScopeData(String scope) {
		this.scope = scope;
	}

	public boolean isSingletonData() {
		return singleton;
	}

	public void setSingletonData(boolean singleton) {
		this.singleton = singleton;
	}

	public String getCloseMethodData() {
		return closeMethod;
	}

	public void setCloseMethodData(String closeMethod) {
