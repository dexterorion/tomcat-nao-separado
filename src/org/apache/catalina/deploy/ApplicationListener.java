...
public class ApplicationListener {
    ...
    public String getClassName() {
        return getClassNameData();
    }


    public boolean isPluggabilityBlocked() {
        return isPluggabilityBlockedData();
    }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getClassNameData() == null) ? 0 : getClassNameData().hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClassNameData() == null) {
            if (other.getClassNameData() != null) {
                return false;
            }
        } else if (!getClassNameData().equals(other.getClassNameData())) {
            return false;
        }
        return true;
    }
	...
	public boolean isPluggabilityBlockedData() {
