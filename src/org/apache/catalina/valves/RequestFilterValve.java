...
public abstract class RequestFilterValve extends ValveBase {
     ...
     */
    private volatile Pattern allow = null;
     ...
     * valid {@link Pattern}.
     */
    private volatile String allowValue = null;
     ...
     */
    private volatile boolean allowValid = true;


    /**
     * The regular expression used to test for denied requests.
     */
    private volatile Pattern deny = null;
     ...
     * valid {@link Pattern}.
     */
    private volatile String denyValue = null;
     ...
     */
    private volatile boolean denyValid = true;
    ...
    protected void initInternal() throws LifecycleException {
        ...
        if (!allowValid || !denyValid) {
            throw new LifecycleException(
                    getSm().getString("requestFilterValve.configInvalid"));
        }
    }
