...
public class MemoryUserDatabaseMemoryUserCreationFactory extends AbstractObjectCreationFactory {

    public MemoryUserDatabaseMemoryUserCreationFactory(MemoryUserDatabase database) {
