...
public class SingleSignOnEntry {
	...
	private Session2 sessions[] = new Session2[0];
	 ...
	 */
	public synchronized void addSession(SingleSignOn sso, Session2 session) {
		for (int i = 0; i < sessions.length; i++) {
			if (session == sessions[i])
				return;
		}
		Session2 results[] = new Session2[sessions.length + 1];
	 ...
	 */
	public synchronized void removeSession(Session2 session) {
		Session2[] nsessions = new Session2[sessions.length - 1];
	 ...
	 */
	public synchronized Session2[] findSessions() {
