...
public class Constants {
	...
	private static final String Package = "org.apache.catalina.authenticator";
     ...
     */
    @Deprecated
    private static final String CERT_METHOD = "CLIENT_CERT";
    ...
    private static final String DEFAULT_KRB5_CONF = "conf/krb5.ini";
    private static final String JAAS_CONF_PROPERTY =
            "java.security.auth.login.config";
    private static final String DEFAULT_JAAS_CONF = "conf/jaas.conf";
    private static final String DEFAULT_LOGIN_MODULE_NAME =
        "com.sun.security.jgss.krb5.accept";
    private static final String USE_SUBJECT_CREDS_ONLY_PROPERTY =
            "javax.security.auth.useSubjectCredsOnly";

    // Cookie name for single sign on support
    private static final String SINGLE_SIGN_ON_COOKIE =
        System.getProperty(
     ...
     */
    private static final String REQ_SSOID_NOTE =
     ...
     */
    private static final String FORM_PRINCIPAL_NOTE =
     ...
     */
    private static final String FORM_REQUEST_NOTE =
        "org.apache.catalina.authenticator.REQUEST";


	public static String getFormRequestNote() {
		return FORM_REQUEST_NOTE;
	}


	public static String getFormPrincipalNote() {
		return FORM_PRINCIPAL_NOTE;
	}


	public static String getSessUsernameNote() {
		return SESS_USERNAME_NOTE;
	}


	public static String getSessPasswordNote() {
		return SESS_PASSWORD_NOTE;
	}


	public static String getReqSsoidNote() {
		return REQ_SSOID_NOTE;
	}


	public static String getSingleSignOnCookie() {
		return SINGLE_SIGN_ON_COOKIE;
	}


	public static String getUseSubjectCredsOnlyProperty() {
		return USE_SUBJECT_CREDS_ONLY_PROPERTY;
	}


	public static String getDefaultLoginModuleName() {
		return DEFAULT_LOGIN_MODULE_NAME;
	}


	public static String getDefaultJaasConf() {
		return DEFAULT_JAAS_CONF;
	}


	public static String getJaasConfProperty() {
		return JAAS_CONF_PROPERTY;
	}


	public static String getDefaultKrb5Conf() {
		return DEFAULT_KRB5_CONF;
	}


	public static String getKrb5ConfProperty() {
		return KRB5_CONF_PROPERTY;
	}


	public static String getFormUsername() {
	...
	public static String getSpnegoMethod() {
	...
	public static String getCertMethod() {
		return CERT_METHOD;
	}


	public static String getBasicMethod() {
		return BASIC_METHOD;
	}
