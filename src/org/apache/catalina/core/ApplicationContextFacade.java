...
public class ApplicationContextFacade implements ServletContext {
    ...
    public FilterRegistrationDynamic addFilter(String filterName,
            String className) {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            return (FilterRegistrationDynamic) doPrivileged(
    ...
    public FilterRegistrationDynamic addFilter(String filterName,
            Filter filter) {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            return (FilterRegistrationDynamic) doPrivileged("addFilter",
    ...
    public ServletRegistrationDynamic addServlet(String servletName,
            String className) {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            return (ServletRegistrationDynamic) doPrivileged(
    ...
    public ServletRegistrationDynamic addServlet(String servletName,
            Servlet servlet) {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            return (ServletRegistrationDynamic) doPrivileged("addServlet",
