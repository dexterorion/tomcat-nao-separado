...
public final class StandardWrapperValve extends ValveBase {
	...
	public final void invoke(Request request, Response response)
		...
		if (servlet instanceof CometProcessor
				&& request.getAttribute(Globals.getCometSupportedAttr()) == Boolean.TRUE) {
			comet = true;
		...
		request.setAttribute(Globals.getDispatcherTypeAttr(), dispatcherType);
