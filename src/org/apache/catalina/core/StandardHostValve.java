...
public final class StandardHostValve extends ValveBase {
    ...
    private static final boolean ACCESS_SESSION;
    ...
    public final void invoke(Request request, Response response)
        ...
        if (asyncAtStart || context.fireRequestInitEvent(request)) {
            ...
            try {
                ...
                if (errorAtStart) {
                    getContainer().getLogger().error("Exception Processing " +
    ...
    private void status(Request request, Response response) {
        ...
        if (errorPage != null && response.setErrorReported()) {
            ...
            request.setAttribute(Globals.getDispatcherRequestPathAttr(),
                    errorPage.getLocation());
            request.setAttribute(Globals.getDispatcherTypeAttr(),
            ...
            if (custom(request, response, errorPage)) {
                try {
                    ...
                    getContainer().getLogger().warn("Exception Processing " + errorPage, e);
                }
            }
        }
    }
    ...
    private boolean custom(Request request, Response response,
        ...
        if (getContainer().getLogger().isDebugEnabled())
            getContainer().getLogger().debug("Processing " + errorPage);
        ...
        try {
            ...
            getContainer().getLogger().error("Exception Processing " + errorPage, t);
            return (false);
