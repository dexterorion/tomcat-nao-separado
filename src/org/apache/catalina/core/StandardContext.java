...
import org.apache.catalina.startup.Constants17;
...
public class StandardContext extends ContainerBase implements Context, NotificationEmitter {
	...
	public StandardContext() {
		...
		// Set defaults
		if (!Globals.isStrictServletCompliance()) {
	 ...
	 */
	private final StandardContextContextFilterMaps filterMaps = new StandardContextContextFilterMaps();
	 ...
	 */
	private int cacheMaxSize = 10240; // 10 MB
	 ...
	 */
	private int cacheObjectMaxSize = 512; // 512K
	 ...
	 */
	private boolean webXmlValidation = Globals.isStrictServletCompliance();

	/**
	 * Attribute value used to turn on/off XML namespace validation
	 */
	private boolean webXmlNamespaceAware = Globals.isStrictServletCompliance();
	 ...
	 */
	private boolean tldValidation = Globals.isStrictServletCompliance();
	...
	public void setDelegate(boolean delegate) {
		...
		getSupport().firePropertyChange("delegate", oldDelegate, this.delegate);
	...
	public void setAntiJARLocking(boolean antiJARLocking) {
		...
		getSupport().firePropertyChange("antiJARLocking", oldAntiJARLocking,
				this.antiJARLocking);
	...
	public void setAntiResourceLocking(boolean antiResourceLocking) {
		...
		getSupport().firePropertyChange("antiResourceLocking",
	...
	public void setCharsetMapper(CharsetMapper mapper) {
		...
		getSupport().firePropertyChange("charsetMapper", oldCharsetMapper,
				this.charsetMapper);
	...
	public void setConfigured(boolean configured) {
		...
		getSupport().firePropertyChange("configured", oldConfigured,
				this.configured);
	...
	public void setCookies(boolean cookies) {
		...
		getSupport().firePropertyChange("cookies", oldCookies, this.cookies);
	...
	public void setSessionCookieName(String sessionCookieName) {
		...
		getSupport().firePropertyChange("sessionCookieName",
	...
	public void setUseHttpOnly(boolean useHttpOnly) {
		...
		getSupport().firePropertyChange("useHttpOnly", oldUseHttpOnly,
				this.useHttpOnly);
	}
	...
	public void setSessionCookieDomain(String sessionCookieDomain) {
		...
		getSupport().firePropertyChange("sessionCookieDomain",
	...
	public void setSessionCookiePath(String sessionCookiePath) {
		...
		getSupport().firePropertyChange("sessionCookiePath",
	...
	public void setCrossContext(boolean crossContext) {
		...
		getSupport().firePropertyChange("crossContext", oldCrossContext,
				this.crossContext);
	...
	public void setAltDDName(String altDDName) {
		...
		if (context != null) {
			context.setAttribute(Globals.getAltDdAttr(), altDDName);
		}
	}
	...
	public void setDisplayName(String displayName) {
		...
		getSupport().firePropertyChange("displayName", oldDisplayName,
				this.displayName);
	}
	...
	public void setDistributable(boolean distributable) {
		...
		getSupport().firePropertyChange("distributable", oldDistributable,
				this.distributable);
	...
	public void setIgnoreAnnotations(boolean ignoreAnnotations) {
		...
		getSupport().firePropertyChange("ignoreAnnotations",
				oldIgnoreAnnotations, this.ignoreAnnotations);
	}
	...
	public void setLoginConfig(LoginConfig config) {
		...
		getSupport().firePropertyChange("loginConfig", oldLoginConfig,
				this.loginConfig);
	...
	public void setNamingResources(NamingResources namingResources) {
		...
		getSupport().firePropertyChange("namingResources", oldNamingResources,
	...
	public void setPublicId(String publicId) {
		...
		getSupport().firePropertyChange("publicId", oldPublicId, publicId);
	...
	public ClassLoader getParentClassLoader() {
		if (super.getParentClassLoader() != null)
	...
	public void setPrivileged(boolean privileged) {
		...
		getSupport().firePropertyChange("privileged", oldPrivileged,
				this.privileged);
	...
	public void setReloadable(boolean reloadable) {
		...
		getSupport().firePropertyChange("reloadable", oldReloadable,
				this.reloadable);
	...
	public void setOverride(boolean override) {
		...
		getSupport().firePropertyChange("override", oldOverride, this.override);
	...
	public void setReplaceWelcomeFiles(boolean replaceWelcomeFiles) {
		...
		getSupport().firePropertyChange("replaceWelcomeFiles",
	...
	public void setSessionTimeout(int timeout) {
		...
		getSupport().firePropertyChange("sessionTimeout", oldSessionTimeout,
				this.sessionTimeout);
	...
	public void setSwallowOutput(boolean swallowOutput) {
		...
		getSupport().firePropertyChange("swallowOutput", oldSwallowOutput,
				this.swallowOutput);
	...
	public void setUnloadDelay(long unloadDelay) {
		...
		getSupport().firePropertyChange("unloadDelay",
				Long.valueOf(oldUnloadDelay), Long.valueOf(this.unloadDelay));
	...
	public synchronized void setResources(DirContext resources) {
		...
		super.setResourcesVariable(null);

		getSupport().firePropertyChange("resources", oldResources,
	...
	public void setCharsetMapperClass(String mapper) {
		...
		getSupport().firePropertyChange("charsetMapperClass",
				oldCharsetMapperClass, this.charsetMapperClass);
	...
	public void setClearReferencesStatic(boolean clearReferencesStatic) {
		...
		getSupport().firePropertyChange("clearReferencesStatic",
	...
	public void setClearReferencesStopThreads(boolean clearReferencesStopThreads) {
		...
		getSupport().firePropertyChange("clearReferencesStopThreads",
	...
	public void setClearReferencesStopTimerThreads(
		...
		getSupport().firePropertyChange("clearReferencesStopTimerThreads",
	...
	public void setRenewThreadsWhenStoppingContext(
		...
		getSupport().firePropertyChange("renewThreadsWhenStoppingContext",
	...
	public void setFailCtxIfServletStartFails(Boolean failCtxIfServletStartFails) {
		...
		getSupport().firePropertyChange("failCtxIfServletStartFails",
	 ...
	 */
	public ServletRegistrationDynamic dynamicServletAdded(Wrapper wrapper) {
		...
		synchronized (filterConfigs) {
			...
			while (names.hasNext()) {
				...
				try {
					...
					t = ExceptionUtils2.unwrapInvocationTargetException(t);
					ExceptionUtils2.handleThrowable(t);
					getLogger().error(
	...
	public boolean listenerStart() {
		...
		if (noPluggabilityListeners.size() > 0) {
			tldEvent = new ServletContextEvent(
					new StandardContextNoPluggabilityServletContext(
							getServletContext()));
		}
	...
	public boolean resourcesStart() {
		...
		try {
			...
			super.setResourcesVariable(proxyDirContext);
		} catch (Throwable t) {
			ExceptionUtils2.handleThrowable(t);
	...
	public boolean resourcesStop() {
		...
		try {
			if (getResources() != null) {
				if (getResources() instanceof Lifecycle) {
					((Lifecycle) getResources()).stop();
				}
				if (webappResources instanceof BaseDirContext) {
				...
				if (isCachingAllowed()) {
					...
					ObjectName resourcesName = new ObjectName(this.getDomain()
							+ ":type=Cache,host=" + getHostname() + ",context="
							+ contextName);
					Registry2.getRegistry(null, null).unregisterComponent(
							resourcesName);
				}
			}
		} catch (Throwable t) {
	...
	protected synchronized void startInternal() throws LifecycleException {
		...
		try {
			...
			if (ok) {
				...
				if ((getLoader() != null) && (getLoader() instanceof Lifecycle))
				...
				if ((getCluster() != null)
						&& (getCluster() instanceof Lifecycle))
					((Lifecycle) getCluster()).start();
				Realm realm = getRealmInternal();
				if ((realm != null) && (realm instanceof Lifecycle))
					((Lifecycle) realm).start();
				if ((getResources() != null)
						&& (getResources() instanceof Lifecycle))
					((Lifecycle) getResources()).start();
				...
				if (getManager() != null && (getCluster() != null)
						&& distributable) {
					// let the cluster know that there is a context that is
					// distributable
					// and that it has its own manager
					getCluster().registerManager(getManager());
				}
			}
		...
		if (ok)
			getServletContext().setAttribute(Globals.getResourcesAttr(),
					getResources());
		...
		try {
			...
			try {
				// Start manager
				if ((getManager() != null)
						&& (getManager() instanceof Lifecycle)) {
	...
	protected synchronized void stopInternal() throws LifecycleException {
		...
		try {
			...
			try {
				...
				if (getManager() != null && getManager() instanceof Lifecycle
						&& ((Lifecycle) getManager()).getState().isAvailable()) {
			...
			if (getPipeline() instanceof Lifecycle
					&& ((Lifecycle) getPipeline()).getState().isAvailable()) {
			...
			if ((getCluster() != null) && (getCluster() instanceof Lifecycle)) {
				((Lifecycle) getCluster()).stop();
			}
			if ((getLoader() != null) && (getLoader() instanceof Lifecycle)) {
	...
	public boolean isServlet22() {
		return XmlIdentifiers.getWeb22Public().equals(publicId);
	}
	...
	protected File engineBase() {
		String base = System.getProperty(Globals.getCatalinaBaseProp());
		if (base == null) {
	...
	public String getDeploymentDescriptor() {
		...
		if (servletContext != null) {
			stream = servletContext
					.getResourceAsStream(Constants17.getApplicationwebxml());
		}
		if (stream == null) {
			return "";
		}
	...
	public static void setUrlEncoder(URLEncoder urlEncoder) {
		StandardContext.urlEncoder = urlEncoder;
	}
	...
	public void setApplicationListeners(
			ApplicationListener[] applicationListeners) {
		this.applicationListeners = applicationListeners;
	}

	public Object[] getApplicationEventListenersObjects() {
		return applicationEventListenersObjects;
	}

	public void setApplicationEventListenersObjects(
			Object[] applicationEventListenersObjects) {
		this.applicationEventListenersObjects = applicationEventListenersObjects;
	}

	public Object[] getApplicationLifecycleListenersObjects() {
		return applicationLifecycleListenersObjects;
	}

	public void setApplicationLifecycleListenersObjects(
			Object[] applicationLifecycleListenersObjects) {
		this.applicationLifecycleListenersObjects = applicationLifecycleListenersObjects;
	}

	public Map<ServletContainerInitializer, Set<Class<?>>> getInitializers() {
		return initializers;
	}
	...
	public void setConstraints(SecurityConstraint[] constraints) {
	...
	public HashMap<String, ErrorPage> getExceptionPages() {
		return exceptionPages;
	}

	public void setExceptionPages(HashMap<String, ErrorPage> exceptionPages) {
		this.exceptionPages = exceptionPages;
	}

	public HashMap<String, ApplicationFilterConfig> getFilterConfigs() {
		return filterConfigs;
	}

	public void setFilterConfigs(
	...
	public String[] getInstanceListeners() {
		return instanceListeners;
	}

	public void setInstanceListeners(String[] instanceListeners) {
		this.instanceListeners = instanceListeners;
	}

	public HashMap<String, MessageDestination> getMessageDestinations() {
		return messageDestinations;
	}

	public void setMessageDestinations(
			HashMap<String, MessageDestination> messageDestinations) {
	...
	public void setMimeMappings(HashMap<String, String> mimeMappings) {
		this.mimeMappings = mimeMappings;
	}

	public ErrorPage getOkErrorPage() {
		return okErrorPage;
	}

	public void setOkErrorPage(ErrorPage okErrorPage) {
		this.okErrorPage = okErrorPage;
	}
	...
	public HashMap<String, String> getRoleMappings() {
		return roleMappings;
	}

	public void setRoleMappings(HashMap<String, String> roleMappings) {
	...
	public void setSequenceNumber(AtomicLong sequenceNumber) {
		this.sequenceNumber = sequenceNumber;
	}

	public HashMap<Integer, ErrorPage> getStatusPages() {
		return statusPages;
	}

	public void setStatusPages(HashMap<Integer, ErrorPage> statusPages) {
		this.statusPages = statusPages;
	}

	public String[] getWatchedResources() {
		return watchedResources;
	}

	public void setWatchedResources(String[] watchedResources) {
		this.watchedResources = watchedResources;
	}

	public String[] getWrapperLifecycles() {
		return wrapperLifecycles;
	}

	public void setWrapperLifecycles(String[] wrapperLifecycles) {
		this.wrapperLifecycles = wrapperLifecycles;
	}

	public String[] getWrapperListeners() {
		return wrapperListeners;
	}

	public void setWrapperListeners(String[] wrapperListeners) {
	...
	public boolean isWebXmlValidation() {
		return webXmlValidation;
	}

	public void setWebXmlValidation(boolean webXmlValidation) {
		this.webXmlValidation = webXmlValidation;
	}

	public boolean isWebXmlNamespaceAware() {
		return webXmlNamespaceAware;
	}

	public void setWebXmlNamespaceAware(boolean webXmlNamespaceAware) {
		this.webXmlNamespaceAware = webXmlNamespaceAware;
	}

	public Set<Servlet> getCreatedServlets() {
		return createdServlets;
	}

	public void setCreatedServlets(Set<Servlet> createdServlets) {
		this.createdServlets = createdServlets;
	}
	...
	public Object getApplicationListenersLock() {
		return applicationListenersLock;
	}

	public Object getApplicationParametersLock() {
		return applicationParametersLock;
	}

	public Object getConstraintsLock() {
		return constraintsLock;
	}

	public StandardContextContextFilterMaps getFilterMaps() {
		return filterMaps;
	}

	public Object getInstanceListenersLock() {
		return instanceListenersLock;
	}

	public Object getSecurityRolesLock() {
		return securityRolesLock;
	}

	public Object getServletMappingsLock() {
		return servletMappingsLock;
	}

	public Object getWatchedResourcesLock() {
		return watchedResourcesLock;
	}

	public Object getWelcomeFilesLock() {
		return welcomeFilesLock;
	}

	public Object getWrapperLifecyclesLock() {
		return wrapperLifecyclesLock;
	}

	public Object getWrapperListenersLock() {
		return wrapperListenersLock;
	}
	...
	public void setNamingContextName(String namingContextName) {
		this.namingContextName = namingContextName;
	}
	...
	public void setResourceOnlyServlets(Set<String> resourceOnlyServlets) {
		this.resourceOnlyServlets = resourceOnlyServlets;
	}
