...
public class AsyncContextImpl implements AsyncContext, AsyncContextCallback {
    ...
    public void start(final Runnable run) {
        ...
        check();
        Runnable wrapper = new AsyncContextImplRunnableWrapper(run, context);
    ...
    private void logDebug(String method) {
        ...
        if (request == null) {
            ...
            Request2 coyoteRequest = request.getCoyoteRequest();
        ...
        if (log.isTraceEnabled()) {
            log.trace(msg, new AsyncContextImplDebugException());
        } else {
            log.debug(msg);
        }
    }
