...
public abstract class ReceiverBase implements ChannelReceiver, ListenCallback,
		RxTaskPoolTaskCreator {

	private static final int OPTION_DIRECT_BUFFER = 0x0004;
	...
	public void start() throws IOException {
		if (executor == null) {
			...
			ReceiverBaseTaskThreadFactory tf = new ReceiverBaseTaskThreadFactory(
					this, "Tribes-Task-Receiver-");
	...
	public static int getOptionDirectBuffer() {
		return OPTION_DIRECT_BUFFER;
	}
