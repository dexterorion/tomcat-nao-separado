    ...
    protected void execute(ObjectReader reader) throws Exception{
        ...
        if ( pkgcnt > 0 ) {
            ...
            for ( int i=0; i<msgs.length; i++ ) {
                 ...
                 */
                if (ChannelData.sendAckAsync(msgs[i].getOptions())) sendAck(Constants20.getAckCommand());
                try {
                    //process the message
                     ...
                     */
                    if (ChannelData.sendAckSync(msgs[i].getOptions())) sendAck(Constants20.getAckCommand());
                }catch  ( Exception x ) {
                    if (ChannelData.sendAckSync(msgs[i].getOptions())) sendAck(Constants20.getFailAckCommand());
