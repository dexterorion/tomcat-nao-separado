...
public class ReplicatedMap<K,V> extends AbstractReplicatedMap<K,V> {
     ...
     */
    public ReplicatedMap(AbstractReplicatedMapMapOwner owner, Channel channel, long timeout, String mapContextName, int initialCapacity,float loadFactor, ClassLoader[] cls) {
     ...
     * @param initialCapacity int - the size of this map, see HashMap
     */
    public ReplicatedMap(AbstractReplicatedMapMapOwner owner, Channel channel, long timeout, String mapContextName, int initialCapacity, ClassLoader[] cls) {
     ...
     * @param mapContextName String - unique name for this map, to allow multiple maps per channel
     */
    public ReplicatedMap(AbstractReplicatedMapMapOwner owner, Channel channel, long timeout, String mapContextName, ClassLoader[] cls) {
     ...
     */
    public ReplicatedMap(AbstractReplicatedMapMapOwner owner, Channel channel, long timeout, String mapContextName, ClassLoader[] cls, boolean terminate) {
...
//------------------------------------------------------------------------------
    ...
    protected int getStateMessageType() {
        return AbstractReplicatedMapMapMessage.getMsgStateCopy();
    }
    ...
    protected Member[] publishEntryInfo(Object key, Object value) throws ChannelException {
        ...
        AbstractReplicatedMapMapMessage msg = new AbstractReplicatedMapMapMessage(getMapContextName(), AbstractReplicatedMapMapMessage.getMsgCopy(), false,
