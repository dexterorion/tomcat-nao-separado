...
public class Catalina {
	...
	protected Digester createStartDigester() {
		...
		digester.addRule("Server/Service/Engine",
				new CatalinaSetParentClassLoaderRule(parentClassLoader));
	...
	public void start() {
		...
		if (useShutdownHook) {
			if (shutdownHook == null) {
				shutdownHook = new CatalinaCatalinaShutdownHook(this);
			}
	...
	protected void initDirs() {
		...
		if (catalinaHome == null) {
			...
			if (j2eeHome != null) {
				...
				catalinaHome = System
						.getProperty(Globals.getCatalinaBaseProp());
			}
		}
		...
		if (System.getProperty(Globals.getCatalinaBaseProp()) == null) {
			System.setProperty(Globals.getCatalinaBaseProp(), catalinaHome);
		} else {
			String catalinaBase = System.getProperty(Globals
					.getCatalinaBaseProp());
