...
public class Embedded  extends StandardService {
    ...
    public void setUseNaming(boolean useNaming) {
        ...
        getSupport().firePropertyChange("useNaming", Boolean.valueOf(oldUseNaming),
    ...
    public void setRedirectStreams(boolean redirectStreams) {
        ...
        getSupport().firePropertyChange("redirectStreams",
    ...
    public void setRealm(Realm realm) {
        ...
        this.realm = realm;
        getSupport().firePropertyChange("realm", oldRealm, this.realm);
    ...
    public synchronized void removeEngine(Engine engine) {
        ...
        while (true) {
            int n = -1;
            for (int i = 0; i < getConnectors().length; i++) {
                if (getConnectors()[i].getService().getContainer() == engine) {
                    n = i;
                    break;
                }
            }
            if (n < 0)
                break;
            removeConnector(getConnectors()[n]);
        }
    ...
    protected void startInternal() throws LifecycleException {
        ...
        for (int i = 0; i < getConnectors().length; i++) {
            ((Lifecycle) getConnectors()[i]).start();
        }
    ...
    protected void stopInternal() throws LifecycleException {
        ...
        for (int i = 0; i < getConnectors().length; i++) {
            ((Lifecycle) getConnectors()[i]).stop();
        }
    ...
    protected void initDirs() {
        ...
        String catalinaHome = System.getProperty(Globals.getCatalinaHomeProp());
        if (catalinaHome == null) {
            // Backwards compatibility patch for J2EE RI 1.3
            String j2eeHome = System.getProperty("com.sun.enterprise.home");
            if (j2eeHome != null) {
                catalinaHome=System.getProperty("com.sun.enterprise.home");
            } else if (System.getProperty(Globals.getCatalinaBaseProp()) != null) {
                catalinaHome = System.getProperty(Globals.getCatalinaBaseProp());
            } else {
                // Use IntrospectionUtils and guess the dir
                catalinaHome = IntrospectionUtils.guessInstall
                    (Globals.getCatalinaHomeProp(), Globals.getCatalinaBaseProp(), "catalina.jar");
                if (catalinaHome == null) {
                    catalinaHome = IntrospectionUtils.guessInstall
                        ("tomcat.install", Globals.getCatalinaHomeProp(), "tomcat.jar");
                }
            }
        }
        ...
        if (catalinaHome != null) {
            ...
            System.setProperty(Globals.getCatalinaHomeProp(), catalinaHome);
        }
        ...
        if (System.getProperty(Globals.getCatalinaBaseProp()) == null) {
            ...
            String catalinaBase = System.getProperty(Globals.getCatalinaBaseProp());
            ...
            System.setProperty(Globals.getCatalinaBaseProp(), catalinaBase);
        }
