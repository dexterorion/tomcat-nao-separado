...
public class RemoteIpFilter implements Filter {
    ...
    private static final String HTTP_SERVER_PORT_PARAMETER = "httpServerPort";

    private static final String HTTPS_SERVER_PORT_PARAMETER = "httpsServerPort";
    
    private static final String INTERNAL_PROXIES_PARAMETER = "internalProxies";
    ...
    private static final String PROTOCOL_HEADER_PARAMETER = "protocolHeader";
    
    private static final String PROTOCOL_HEADER_HTTPS_VALUE_PARAMETER = "protocolHeaderHttpsValue";
    
    private static final String PORT_HEADER_PARAMETER = "portHeader";

    private static final String CHANGE_LOCAL_PORT_PARAMETER = "changeLocalPort";

    private static final String PROXIES_HEADER_PARAMETER = "proxiesHeader";
    
    private static final String REMOTE_IP_HEADER_PARAMETER = "remoteIpHeader";
    
    private static final String TRUSTED_PROXIES_PARAMETER = "trustedProxies";
    ...
    public void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (internalProxies != null &&
            ...
            RemoteIpFilterXForwardedRequest xRequest = new RemoteIpFilterXForwardedRequest(request);
            if (remoteIp != null) {
            ...
            if (requestAttributesEnabled) {
                ...
                request.setAttribute(Globals.getRemoteAddrAttribute(),
                        xRequest.getRemoteAddr());
    ...
    private void setPorts(RemoteIpFilterXForwardedRequest xrequest, int defaultPort) {
