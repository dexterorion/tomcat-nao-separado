...
public class FarmWarDeployer extends ClusterListener implements
	...
	private static final StringManager3 sm = StringManager3.getManager(Constants6
			.getPackage());
	...
	private HashMap<String, FileMessageFactory> fileFactories = new HashMap<String, FileMessageFactory>();
	...
	private WarWatcher watcher = null;
	 ...
	 */
	private int processDeployFrequency = 2;
