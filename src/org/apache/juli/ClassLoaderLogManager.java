...
public class ClassLoaderLogManager extends LogManager {
    ...
    public ClassLoaderLogManager() {
        super();
        try { 
            Runtime.getRuntime().addShutdownHook(new ClassLoaderLogManagerCleaner(this));
     ...
     */
    private final Map<ClassLoader, ClassLoaderLogManagerClassLoaderLogInfo> classLoaderLoggers = 
        new WeakHashMap<ClassLoader, ClassLoaderLogManagerClassLoaderLogInfo>();
     ...
     */
    private ThreadLocal<String> prefix = new ThreadLocal<String>();
     ...
     */
    private volatile boolean useShutdownHook = true;
    ...
    public synchronized Logger getLogger(final String name) {
        ...
        return getClassLoaderInfo(classLoader).getLoggers().get(name);
    }
    ...
    public synchronized Enumeration<String> getLoggerNames() {
        ClassLoader classLoader = Thread.currentThread()
                .getContextClassLoader();
        return Collections.enumeration(getClassLoaderInfo(classLoader).getLoggers().keySet());
    }
    ...
    public void reset() throws SecurityException {
        ...
        ClassLoaderLogManagerClassLoaderLogInfo clClassLoaderLogManagerClassLoaderLogInfo = getClassLoaderInfo(classLoader);
        resetLoggers(clClassLoaderLogManagerClassLoaderLogInfo);
        super.reset();
    }
    ...
    public void shutdown() {
        ...
        for (ClassLoaderLogManagerClassLoaderLogInfo clClassLoaderLogManagerClassLoaderLogInfo : classLoaderLoggers.values()) {
            resetLoggers(clClassLoaderLogManagerClassLoaderLogInfo);
        }
    }

    // -------------------------------------------------------- Private Methods
    private void resetLoggers(ClassLoaderLogManagerClassLoaderLogInfo clClassLoaderLogManagerClassLoaderLogInfo) {
        ...
        // ClassLoaderClassLoaderLogManagerClassLoaderLogInfo#handlers list. That is because our #addLogger(..)
     ...
     *                    configuration
     */
    protected ClassLoaderLogManagerClassLoaderLogInfo getClassLoaderInfo(ClassLoader classLoader) {
    ...
    protected void readConfiguration(ClassLoader classLoader)
        ...
        try {
            ...
            // Log and carry on
            ClassLoaderLogManagerClassLoaderLogInfo info = classLoaderLoggers.get(ClassLoader.getSystemClassLoader());
            if (info != null) {
        ...
        ClassLoaderLogManagerClassLoaderLogInfo info = 
            new ClassLoaderLogManagerClassLoaderLogInfo(new ClassLoaderLogManagerLogNode(null, localClassLoaderLogManagerRootLogger));
	...
	public ThreadLocal<String> getPrefix() {
		return prefix;
	}


	public void setPrefix(ThreadLocal<String> prefix) {
		this.prefix = prefix;
	}


	public static String getDebugProperty() {
		return DEBUG_PROPERTY;
	}


	public Map<ClassLoader, ClassLoaderLogManagerClassLoaderLogInfo> getClassLoaderLoggers() {
		return classLoaderLoggers;
	}
}