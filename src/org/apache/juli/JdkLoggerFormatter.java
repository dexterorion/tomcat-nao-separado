...
public class JdkLoggerFormatter extends Formatter {
    ...
    private static final int LOG_LEVEL_TRACE  = 400;
    private static final int LOG_LEVEL_DEBUG  = 500;
    private static final int LOG_LEVEL_INFO   = 800;
    private static final int LOG_LEVEL_WARN   = 900;
    private static final int LOG_LEVEL_ERROR  = 1000;
    private static final int LOG_LEVEL_FATAL  = 1000;
