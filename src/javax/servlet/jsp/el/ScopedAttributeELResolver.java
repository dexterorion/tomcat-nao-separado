...
public class ScopedAttributeELResolver extends ELResolver {
	...
	public Iterator<FeatureDescriptor> getFeatureDescriptors(ELContext context,
		...
		e = ctxt.getAttributeNamesInScope(PageContext.getPageScope());
		while (e.hasMoreElements()) {
			name = e.nextElement();
			value = ctxt.getAttribute(name, PageContext.getPageScope());
		...
		e = ctxt.getAttributeNamesInScope(PageContext.getRequestScope());
		while (e.hasMoreElements()) {
			name = e.nextElement();
			value = ctxt.getAttribute(name, PageContext.getRequestScope());
			FeatureDescriptor descriptor = new FeatureDescriptor();
			descriptor.setName(name);
			descriptor.setDisplayName(name);
			descriptor.setExpert(false);
		...
		if (ctxt.getSession() != null) {
			e = ctxt.getAttributeNamesInScope(PageContext.getSessionScope());
			while (e.hasMoreElements()) {
				name = e.nextElement();
				value = ctxt.getAttribute(name, PageContext.getSessionScope());
				FeatureDescriptor descriptor = new FeatureDescriptor();
				descriptor.setName(name);
				descriptor.setDisplayName(name);
				descriptor.setExpert(false);
		...
		e = ctxt.getAttributeNamesInScope(PageContext.getApplicationScope());
		while (e.hasMoreElements()) {
			name = e.nextElement();
			value = ctxt.getAttribute(name, PageContext.getApplicationScope());
			FeatureDescriptor descriptor = new FeatureDescriptor();
			descriptor.setName(name);
			descriptor.setDisplayName(name);
			descriptor.setExpert(false);
