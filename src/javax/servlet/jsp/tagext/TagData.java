...
public class TagData implements Cloneable {
    ...
    private static final Object REQUEST_TIME_VALUE = new Object();
    ...
    public String getId() {
        return getAttributeString(TagAttributeInfo.getId());
    }
    ...
    public static Object getRequestTimeValue() {
		return REQUEST_TIME_VALUE;
	}
