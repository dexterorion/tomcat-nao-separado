...
public abstract class ELResolver {
    ...
    private static final String RESOLVABLE_AT_DESIGN_TIME = "resolvableAtDesignTime";
	...
	public static String getResolvableAtDesignTime() {
		return RESOLVABLE_AT_DESIGN_TIME;
	}
