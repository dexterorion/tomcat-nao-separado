...
public abstract class ExpressionEvaluator {
     ...
     * @exception ELException2
     *                Thrown if parsing errors were found.
     */
    public abstract Expression2 parseExpression(String expression,
            @SuppressWarnings("rawtypes")// TCK signature fails with generics
            Class expectedType, FunctionMapper fMapper) throws ELException2;
    ...
    public abstract Object evaluate(
            ...
            FunctionMapper fMapper) throws ELException2;
}
