...
public class TagInfo {
    ...
    private static final String BODY_CONTENT_JSP = "JSP";

    /**
     * Static constant for getBodyContent() when it is Tag dependent.
     */

    private static final String BODY_CONTENT_TAG_DEPENDENT = "tagdependent";
    ...
    private static final String BODY_CONTENT_EMPTY = "empty";
     ...
     * @since 2.0
     */ 
    private static final String BODY_CONTENT_SCRIPTLESS = "scriptless";
   ...
   public VariableInfo[] getVariableInfo(TagData data) {
    ...
    public static String getBodyContentJsp() {
		return BODY_CONTENT_JSP;
	}

	public static String getBodyContentTagDependent() {
		return BODY_CONTENT_TAG_DEPENDENT;
	}

	public static String getBodyContentEmpty() {
		return BODY_CONTENT_EMPTY;
	}

	public static String getBodyContentScriptless() {
		return BODY_CONTENT_SCRIPTLESS;
	}
