...
public final class DefaultClientEndpointConfig implements ClientEndpointConfig {
    ...
    private final ClientEndpointConfigConfigurator configurator;


    public DefaultClientEndpointConfig(List<String> preferredSubprotocols,
            List<Extension> extensions,
            List<Class<? extends Encoder>> encoders,
            List<Class<? extends Decoder>> decoders,
            ClientEndpointConfigConfigurator configurator) {
    ...
    @Override
    public ClientEndpointConfigConfigurator getConfigurator() {
        return configurator;
    }
}
