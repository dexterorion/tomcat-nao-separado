...
public class ServiceRef extends Reference {
	...
	private static final String SERVICE_LOCAL_PART = "service local part";
	 ...
	 */
	private static final String JAXRPCMAPPING = "jaxrpcmapping";

	/**
	 * port-component-ref/port-component-link address type.
	 */
	private static final String PORTCOMPONENTLINK = "portcomponentlink";

	/**
	 * port-component-ref/service-endpoint-interface address type.
	 */
	private static final String SERVICEENDPOINTINTERFACE = "serviceendpointinterface";
	...
	public static String getPortcomponentlink() {
		return PORTCOMPONENTLINK;
	}

	public static String getServiceendpointinterface() {
		return SERVICEENDPOINTINTERFACE;
	}

	public Vector<HandlerRef> getHandlers() {
		return handlers;
	}

	public void setHandlers(Vector<HandlerRef> handlers) {
	...
	public static String getServiceInterface() {
	...
	public static String getServiceLocalPart() {
	...
	public static String getJaxrpcmapping() {
