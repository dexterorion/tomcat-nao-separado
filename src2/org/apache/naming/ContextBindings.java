...
public class ContextBindings {
     ...
     */
    private static final StringManager2 sm = 
        StringManager2.getManager(Constants29.getPackage());
     ...
     * @param name Name of the context
     */
    public static Context getContext(Object name) {
     ...
     */
    public static Object getClassLoaderName()
        throws NamingException {
        ClassLoader cl = Thread.currentThread().getContextClassLoader();
        Object name = null;
        do {
