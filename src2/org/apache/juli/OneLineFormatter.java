...
public class OneLineFormatter extends Formatter {
    ...
    private static final DateFormatCache globalDateCache =
            new DateFormatCache(globalCacheSize, getTimeformat(), null);

    /**
     * Thread local date format cache.
     */
    private static final ThreadLocal<DateFormatCache> localDateCache = new ThreadLocal2();
	...
	public static DateFormatCache getGlobaldatecache() {
