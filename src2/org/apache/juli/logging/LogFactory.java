...
public /* abstract */ class LogFactory {
     ...
     * </p>
     */
	private static final String HASHTABLE_IMPLEMENTATION_PROPERTY =
    ...
    public void setLogConfig( Properties p ) {
        this.logConfig=p;
    }
	...
	public static String getFactoryProperty() {
		return FACTORY_PROPERTY;
	}

	public static String getFactoryDefault() {
		return FACTORY_DEFAULT;
	}

	public static String getFactoryProperties() {
		return FACTORY_PROPERTIES;
	}

	public static String getHashtableImplementationProperty() {
		return HASHTABLE_IMPLEMENTATION_PROPERTY;
	}
}
