...
public class JspServletWrapper {
    ...
    private FastRemovalDequeueEntry<JspServletWrapper> unloadHandle;
    ...
    public FastRemovalDequeueEntry<JspServletWrapper> getUnloadHandle() {
        return unloadHandle;
    }
            ...
            if (options.getDisplaySourceFragment()) {
                return new JasperException(Localizer.getMessage
                        ("jsp.exception", detail.getJspFileName(),
                                "" + jspLineNumber) + Constants28.getNewline() +
                                Constants28.getNewline() + detail.getJspExtract() +
                                Constants28.getNewline() + Constants28.getNewline() + 
                                "Stacktrace:", ex);
