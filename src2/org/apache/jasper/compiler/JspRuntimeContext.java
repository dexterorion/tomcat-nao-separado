...
import org.apache.jasper.security.SecurityClassLoad2;
import org.apache.jasper.servlet.JspServletWrapper;
import org.apache.jasper.util.ExceptionUtils;
import org.apache.jasper.util.FastRemovalDequeue;
import org.apache.jasper.util.FastRemovalDequeueEntry;
...
public final class JspRuntimeContext {
    ...
    static {
        ...
        SecurityClassLoad2.securityClassLoad(factory.getClass().getClassLoader());
    ...
    public JspRuntimeContext(ServletContext context, Options options) {
        ...
        if (Constants28.isSecurityEnabled()) {
            JspRuntimeContextSecurityHolder holder = initSecurity();
            codeSource = holder.getCs();
            permissionCollection = holder.getPc();
        } else {
            codeSource = null;
            permissionCollection = null;
        }
     ...
     * */
    public FastRemovalDequeueEntry<JspServletWrapper> push(JspServletWrapper jsw) {
        if (log.isTraceEnabled()) {
            log.trace(Localizer.getMessage("jsp.message.jsp_added",
                                           jsw.getJspUri(), context.getContextPath()));
        }
        FastRemovalDequeueEntry<JspServletWrapper> entry = jspQueue.push(jsw);
     ...
     * */
    public void makeYoungest(FastRemovalDequeueEntry<JspServletWrapper> unloadHandle) {
        if (log.isTraceEnabled()) {
    ...
    private String initClassPath() {
        ...
        String cp = (String) context.getAttribute(Constants28.getServletClasspath());
     ...
     */
    private JspRuntimeContextSecurityHolder initSecurity() {
        ...
        return new JspRuntimeContextSecurityHolder(source, permissions);
    }
