...
public class JspCompilationContext {
    ...
    private Map<String, JarResource> tagFileJarUrls;
    ...
    private JarResource tagJarResource;
    ...
    public JspCompilationContext(String jspUri,
        ...
        this.basePackageName = Constants28.getJspPackageName();
    }
     ...
     */
    public Compiler2 createCompiler() {
        if (jspCompiler != null ) {
            return jspCompiler;
        }
        jspCompiler = null;
    ...
    protected Compiler2 createCompiler(String className) {
        Compiler2 compiler = null;
        try {
            compiler = (Compiler2) Class.forName(className).newInstance();
    ...
    private static Object outputDirLock = new Object();
