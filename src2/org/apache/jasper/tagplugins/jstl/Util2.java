...
public class Util2 {
    ...
    public static int getScope(String scope){
        int ret = PageContext.getPageScope();
        
        if("request".equalsIgnoreCase(scope)){
            ret = PageContext.getRequestScope();
        }else if("session".equalsIgnoreCase(scope)){
            ret = PageContext.getSessionScope();
        }else if("application".equalsIgnoreCase(scope)){
            ret = PageContext.getApplicationScope();
        }
    ...
    public static String stripSession(String url) {
        ...
        int sessionStart;
        while ((sessionStart = u.toString().indexOf(";" + Constants28.getSessionParameterName() + "=")) != -1) {
