...
public class JspHelper {
     ...
     * @return String
     */
    public static String guessDisplayLocaleFromSession(Session2 in_session) {
     ...
     * @return String
     */
    public static String guessDisplayUserFromSession(Session2 in_session) {
        Object user = SessionUtils.guessUserFromSession(in_session);
        return escapeXml(user);
    }


    public static String getDisplayCreationTimeForSession(Session2 in_session) {
        try {
    ...
    public static String getDisplayLastAccessedTimeForSession(Session2 in_session) {
        try {
    ...
    public static String getDisplayUsedTimeForSession(Session2 in_session) {
        try {
            if (in_session.getCreationTime() == 0) {
                return "";
            }
    ...
    public static String getDisplayTTLForSession(Session2 in_session) {
        try {
            if (in_session.getCreationTime() == 0) {
                return "";
            }
    ...
    public static String getDisplayInactiveTimeForSession(Session2 in_session) {
        try {
            if (in_session.getCreationTime() == 0) {
                return "";
            }
