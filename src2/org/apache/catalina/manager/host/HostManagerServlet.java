...
public class HostManagerServlet extends HttpServlet implements ContainerServlet {
	 ...
	 * The associated host.
	 */
	private transient Host installedHost = null;
	 ...
	 */
	private static final StringManager3 sm = StringManager3.getManager(Constants11
			.getPackage());
	...
	public void setWrapper(Wrapper wrapper) {
		...
		setmBeanServer(Registry2.getRegistry(null, null).getMBeanServer());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		StringManager3 smClient = StringManager3.getManager(
				Constants11.getPackage(), request.getLocales());
		...
		response.setContentType("text/plain; charset=" + Constants11.getCharset());
	...
	protected void add(HttpServletRequest request, PrintWriter writer,
			String name, boolean htmlMode, StringManager3 smClient) {
	...
	protected synchronized void add(PrintWriter writer, String name,
			...
			boolean unpackWARs, boolean copyXML, StringManager3 smClient) {
		if (debug >= 1) {
	 ...
	 *            Host name
	 */
	protected void start(PrintWriter writer, String name, StringManager3 smClient) {
	 ...
	 *            Host name
	 */
	protected void stop(PrintWriter writer, String name, StringManager3 smClient) {
	...
	protected File getConfigBase(String hostName) {
		File configBase = new File(System.getProperty(Globals
				.getCatalinaBaseProp()), "conf");
	...
	public Host getInstalledHost() {
		return installedHost;
	}

	public void setInstalledHost(Host installedHost) {
