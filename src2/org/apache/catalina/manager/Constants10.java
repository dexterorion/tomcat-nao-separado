...
public class Constants10 {
	...
	private static final String Package = "org.apache.catalina.manager";
	...
	private static final String XML_DECLARATION = "<?xml version=\"1.0\" encoding=\""
			+ CHARSET + "\"?>";

	private static final String XML_STYLE = "<?xml-stylesheet type=\"text/xsl\" href=\"{0}/xform.xsl\" ?>\n";

	public static String getHtmlHeaderSection() {
		return HTML_HEADER_SECTION;
	}
	...
	public static String getBodyHeaderSection() {
		return BODY_HEADER_SECTION;
	}

	public static String getMessageSection() {
		return MESSAGE_SECTION;
	}

	public static String getManagerSection() {
		return MANAGER_SECTION;
	}

	public static String getServerHeaderSection() {
		return SERVER_HEADER_SECTION;
	}

	public static String getServerRowSection() {
		return SERVER_ROW_SECTION;
	}

	public static String getHtmlTailSection() {
		return HTML_TAIL_SECTION;
	}
	...
	public static String getXmlStyle() {
		return XML_STYLE;
	}
