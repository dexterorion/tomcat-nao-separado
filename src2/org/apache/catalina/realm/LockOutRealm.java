...
public class LockOutRealm extends CombinedRealm {
     ...
     */
    private static final String name = "LockOutRealm";
    ...
    protected void startInternal() throws LifecycleException {
        ...
        failedUsers = new LinkedHashMap<String, LockOutRealmLockRecord>(cacheSize, 0.75f,
                true) {
            private static final long serialVersionUID = 1L;
            @Override
            protected boolean removeEldestEntry(
                    Map.Entry<String, LockOutRealmLockRecord> eldest) {
                if (size() > cacheSize) {
                    ...
                    if (timeInCache < cacheRemovalWarningTime) {
                        log.warn(getSm().getString("lockOutRealm.removeWarning",
    ...
    public Principal authenticate(String username, String clientDigest,
        ...
        if (isLocked(username)) {
            ...
            log.warn(getSm().getString("lockOutRealm.authLockedUser", username));
            return null;
        }
    ...
    private boolean isLocked(String username) {
    	LockOutRealmLockRecord lockRecord = null;
        synchronized (this) {
    ...
    private void registerAuthFailure(String username) {
        ...
        synchronized (this) {
            if (!failedUsers.containsKey(username)) {
                lockRecord = new LockOutRealmLockRecord(); 
