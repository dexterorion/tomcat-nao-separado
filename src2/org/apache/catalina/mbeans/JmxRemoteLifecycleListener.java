...
public class JmxRemoteLifecycleListener implements LifecycleListener {
    ...
    private static final StringManager3 sm =
        StringManager3.getManager(Constants12.getPackage());

    private String rmiBindAddress = null;
    private int rmiRegistryPortPlatform = -1;
    private int rmiServerPortPlatform = -1;
    private boolean rmiSSL = true;
    ...
    private boolean useLocalPorts = false;

    private JMXConnectorServer csPlatform = null;
    ...
    public void lifecycleEvent(LifecycleEvent event) {
        ...
        if (Lifecycle.START_EVENT == event.getType()) {
            ...
            if (rmiBindAddress != null) {
                try {
                    ssf = new JmxRemoteLifecycleListenerRmiServerBindSocketFactory(
            ...
            if (useLocalPorts) {
                csf = new JmxRemoteLifecycleListenerRmiClientLocalhostSocketFactory(csf);
            }
