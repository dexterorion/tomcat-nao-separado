 ...
 */
public final class ApplicationFilterChain implements FilterChain, CometFilterChain {
    ...
    static {
        if (ApplicationDispatcher.isWrapSameObject()) {
    ...
    private void internalDoFilter(ServletRequest request, 
        ...
        if (pos < n) {
            ...
            try {
                ...
                support.fireInstanceEvent(InstanceEvent.getBeforeFilterEvent(),
                                          filter, request, response);
                
                if (request.isAsyncSupported() && "false".equalsIgnoreCase(
                        filterConfig.getFilterDef().getAsyncSupported())) {
                    request.setAttribute(Globals.getAsyncSupportedAttr(),
                            Boolean.FALSE);
                }
                if( Globals.isSecurityEnabled() ) {
                    final ServletRequest req = request;
                ...
                support.fireInstanceEvent(InstanceEvent.getAfterFilterEvent(),
                                          filter, request, response);
            } catch (IOException e) {
                if (filter != null)
                    support.fireInstanceEvent(InstanceEvent.getAfterFilterEvent(),
        ...
        try {
            ...
            support.fireInstanceEvent(InstanceEvent.getBeforeServiceEvent(),
            ...
            support.fireInstanceEvent(InstanceEvent.getAfterServiceEvent(),
                                      servlet, request, response);
        } catch (IOException e) {
            support.fireInstanceEvent(InstanceEvent.getAfterServiceEvent(),
