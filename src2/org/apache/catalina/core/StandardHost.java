...
public class StandardHost extends ContainerBase implements Host {
	...
	public StandardHost() {
		...
		super();
		getPipeline().setBasic(new StandardHostValve());
	 ...
	 */
	private boolean deployXML = !Globals.isSecurityEnabled();
	...
	public ThreadPoolExecutor getStartStopExecutor() {
		return super.getStartStopExecutor();
	}
	...
	public void setAppBase(String appBase) {
		...
		getSupport().firePropertyChange("appBase", oldAppBase, this.appBase);
	...
	public void setXmlBase(String xmlBase) {
		...
		getSupport().firePropertyChange("xmlBase", oldXmlBase, this.xmlBase);
	...
	public void setAutoDeploy(boolean autoDeploy) {
		...
		getSupport().firePropertyChange("autoDeploy", oldAutoDeploy,
				this.autoDeploy);
	...
	public void setConfigClass(String configClass) {
		...
		getSupport().firePropertyChange("configClass", oldConfigClass,
				this.configClass);
	...
	public void setContextClass(String contextClass) {
		...
		getSupport().firePropertyChange("contextClass", oldContextClass,
				this.contextClass);
	...
	public void setDeployOnStartup(boolean deployOnStartup) {
		...
		getSupport().firePropertyChange("deployOnStartup", oldDeployOnStartup,
	...
	public void setErrorReportValveClass(String errorReportValveClass) {
		...
		getSupport().firePropertyChange("errorReportValveClass",
	...
	public void setName(String name) {
		...
		super.setName(name);
		getSupport().firePropertyChange("name", oldName, this.getName());
	...
	public void setDeployIgnore(String deployIgnore) {
		...
		getSupport().firePropertyChange("deployIgnore", oldDeployIgnore,
				deployIgnore);
	}
	...
	public void addChild(Container child) {
		...
		child.addLifecycleListener(new StandardHostMemoryLeakTrackingListener(
				this));
	...
	public Map<ClassLoader, String> getChildClassLoaders() {
		return childClassLoaders;
	}

	public void setChildClassLoaders(Map<ClassLoader, String> childClassLoaders) {
