...
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    public synchronized void storeConfig() throws Exception {
        ...
        getMserver().invoke(sname, "storeConfig", null, null);            
    }
     ...
     */
    public synchronized void storeContext(javax.naming.Context context) throws Exception {
        
        ObjectName sname = null;    
        try {
           sname = new ObjectName("Catalina:type=StoreConfig");
           if(getMserver().isRegistered(sname)) {
               getMserver().invoke(sname, "store",
                   new Object[] {context}, 
