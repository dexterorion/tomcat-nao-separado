...
public class StandardEngine extends ContainerBase implements Engine {
    ...
    public void setDefaultHost(String host) {
        ...
        getSupport().firePropertyChange("defaultHost", oldDefaultHost,
                                   this.defaultHost);
    ...
    public String getBaseDir() {
        ...
        if( baseDir==null ) {
            baseDir=System.getProperty(Globals.getCatalinaHomeProp());
        }
        return baseDir;
    }
    ...
    public void logAccess(Request request, Response response, long time,
        ...
        if (!logged && useDefault) {
            ...
            if (newDefaultAccessLog == null) {
                ...
                if (host != null && host.getState().isAvailable()) {
                    ...
                    if (newDefaultAccessLog != null) {
                        if (defaultAccessLog.compareAndSet(null,
                                newDefaultAccessLog)) {
                        	StandardEngineAccessLogListener l = new StandardEngineAccessLogListener(this,
                                    host, null);
                            l.install();
                        }
                    } else {
                        ...
                        if (context != null &&
                            ...
                            if (newDefaultAccessLog != null) {
                                if (defaultAccessLog.compareAndSet(null,
                                        newDefaultAccessLog)) {
                                	StandardEngineAccessLogListener l = new StandardEngineAccessLogListener(
                                            this, null, context);
                                    l.install();
                                }
                            }
                ...
                if (newDefaultAccessLog == null) {
                    newDefaultAccessLog = new StandardEngineNoopAccessLog();
                    if (defaultAccessLog.compareAndSet(null,
                            newDefaultAccessLog)) {
                    	StandardEngineAccessLogListener l = new StandardEngineAccessLogListener(this, host,
                                context);
                        l.install();
                    }
                }
	...
	public AtomicReference<AccessLog> getDefaultAccessLog() {
