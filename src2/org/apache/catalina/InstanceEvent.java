...
public final class InstanceEvent extends EventObject {
	...
	public static String getAfterFilterEvent() {
		return AFTER_FILTER_EVENT;
	}


	public static String getBeforeFilterEvent() {
		return BEFORE_FILTER_EVENT;
	}


	public static String getAfterDispatchEvent() {
		return AFTER_DISPATCH_EVENT;
	}


	public static String getBeforeDispatchEvent() {
		return BEFORE_DISPATCH_EVENT;
	}


	public static String getAfterDestroyEvent() {
		return AFTER_DESTROY_EVENT;
	}


	public static String getBeforeDestroyEvent() {
		return BEFORE_DESTROY_EVENT;
	}


	public static String getAfterServiceEvent() {
		return AFTER_SERVICE_EVENT;
	}


	public static String getBeforeServiceEvent() {
		return BEFORE_SERVICE_EVENT;
	}


	public static String getAfterInitEvent() {
		return AFTER_INIT_EVENT;
	}


	public static String getBeforeInitEvent() {
		return BEFORE_INIT_EVENT;
	}
