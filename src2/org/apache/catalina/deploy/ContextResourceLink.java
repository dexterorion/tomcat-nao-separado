...
public class ContextResourceLink extends ResourceBase {
   ...
   /**
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFactoryData() == null) ? 0 : getFactoryData().hashCode());
        result = prime * result + ((getGlobalData() == null) ? 0 : getGlobalData().hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getFactoryData() == null) {
            if (other.getFactoryData() != null) {
                return false;
            }
        } else if (!getFactoryData().equals(other.getFactoryData())) {
            return false;
        }
        if (getGlobalData() == null) {
            if (other.getGlobalData() != null) {
                return false;
            }
        } else if (!getGlobalData().equals(other.getGlobalData())) {
            return false;
        }
        return true;
    }
	...
	public void setFactoryData(String factory) {
	...
	public void setGlobalData(String global) {
		this.global = global;
	}
}
