...
public class FilterMap implements Serializable {
	...
	public void setDispatcherMapping(int dispatcherMapping) {
	...
	public void setMatchAllUrlPatterns(boolean matchAllUrlPatterns) {
		this.matchAllUrlPatterns = matchAllUrlPatterns;
	}

	public void setMatchAllServletNames(boolean matchAllServletNames) {
		this.matchAllServletNames = matchAllServletNames;
	}
