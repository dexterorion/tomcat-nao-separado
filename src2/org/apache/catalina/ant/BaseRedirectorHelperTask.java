...
public abstract class BaseRedirectorHelperTask extends Task {
	...
	private RedirectorElement redirectorElement = null;
    /** The stream for info output */
	private OutputStream redirectOutStream = null;
    /** The stream for error output */
	private OutputStream redirectErrStream = null;
    /** The print stream for info output */
	private PrintStream redirectOutPrintStream = null;
    /** The print stream for error output */
	private PrintStream redirectErrPrintStream = null;
   ...
   /**
    ...
    /** 
      ...
      * complete.
      */    
	private boolean redirectorConfigured = false;
