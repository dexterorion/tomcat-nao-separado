...
public final class RequestUtil {
    ...
    private static final StringManager3 sm =
        StringManager3.getManager("org.apache.catalina.util");
     ...
     *             org.apache.tomcat.util.http.RequestUtil2#normalize(String)} as
     *             a replacement.
     */
    @Deprecated
    public static String normalize(String path) {
        return org.apache.tomcat.util.http.RequestUtil2.normalize(path);
    }
     ...
     * @deprecated Deprecated to resolve a circular package dependency and will
     *             be removed in Tomcat 8.0.x. Use {@link
     *             org.apache.tomcat.util.http.RequestUtil2#normalize(String,
