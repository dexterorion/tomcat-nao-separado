...
public class DateTool {
	 ...
	 */
	private static final ThreadLocal<DateFormat> rfc1123Format = new ThreadLocal<DateFormat>() {
		@Override
	 ...
	 */
	private static final ThreadLocal<DateFormat> oldCookieFormat = new ThreadLocal<DateFormat>() {
		@Override
		public DateFormat initialValue() {
	...
	private static final ThreadLocal<DateFormat> rfc1036Format = new ThreadLocal<DateFormat>() {
		@Override
		public DateFormat initialValue() {
	...
	private static final ThreadLocal<DateFormat> asctimeFormat = new ThreadLocal<DateFormat>() {
		@Override
		public DateFormat initialValue() {
	...
	public static String getHttpResponseDateHeader() {
		return HTTP_RESPONSE_DATE_HEADER;
	}
