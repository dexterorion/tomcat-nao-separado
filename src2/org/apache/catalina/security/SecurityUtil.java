...
public final class SecurityUtil{
    ...
    private static final StringManager3 sm =
        StringManager3.getManager(Constants14.getPackage());
    ...
    private static void execute(final Method method,
        ...
        try{
            ...
            if (targetArguments != null
                ...
                if (session != null){
                    subject =
                        (Subject)session.getAttribute(Globals.getSubjectAttr());
    ...
    public static boolean isPackageProtectionEnabled(){
        if (packageDefinitionEnabled && Globals.isSecurityEnabled()){
            return true;
        }
        return false;
    }
