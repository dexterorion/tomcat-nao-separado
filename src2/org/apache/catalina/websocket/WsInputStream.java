...
public class WsInputStream extends InputStream {
    ...
    private static final StringManager3 sm =
            StringManager3.getManager(Constants23.getPackage());
    ...
    private void makePayloadDataAvailable() throws IOException {
        ...
        while (remaining == 0 && !frame.getFin()) {
            ...
            while (frame.isControl()) {
                if (frame.getOpCode() == Constants23.getOpcodePing()) {
                    outbound.pong(frame.getPayLoad());
                } else if (frame.getOpCode() == Constants23.getOpcodePong()) {
                    // NO-OP. Swallow it.
                } else if (frame.getOpCode() == Constants23.getOpcodeClose()) {
            ...
            if (frame.getOpCode() != Constants23.getOpcodeContinuation()) {
