...
public class NioSender extends AbstractSender {
    ...
    private XByteBuffer ackbuf = new XByteBuffer(128,true);
    ...
    protected boolean read(SelectionKey key) throws IOException {
        ...
        if (ackbuf.doesPackageExist() ) {
            ...
            boolean ack = Arrays.equals(ackcmd,org.apache.catalina.tribes.transport.Constants20.getAckData());
            boolean fack = Arrays.equals(ackcmd,org.apache.catalina.tribes.transport.Constants20.getFailAckData());
