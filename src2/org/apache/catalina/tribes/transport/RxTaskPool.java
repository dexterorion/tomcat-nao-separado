...
public class RxTaskPool
{
	...
	private List<AbstractRxTask> idle = new LinkedList<AbstractRxTask>();
	private List<AbstractRxTask> used = new LinkedList<AbstractRxTask>();
    ...
    private RxTaskPoolTaskCreator creator = null;

    
    public RxTaskPool (int maxTasks, int minTasks, RxTaskPoolTaskCreator creator) throws Exception {
...
//            task.start();
    ...
    public RxTaskPoolTaskCreator getTaskCreator() {
        return this.creator;
    }
}
