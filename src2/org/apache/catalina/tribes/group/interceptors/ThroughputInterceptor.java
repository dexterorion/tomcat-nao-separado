...
public class ThroughputInterceptor extends ChannelInterceptorBase {
    ...
    private double mbTx = 0;
    private double mbAppTx = 0;
    private double mbRx = 0;
    private double timeTx = 0;
    private double lastCnt = 0;
    private AtomicLong msgTxCnt = new AtomicLong(1);
    private AtomicLong msgRxCnt = new AtomicLong(0);
    private AtomicLong msgTxErr = new AtomicLong(0);
    private int interval = 10000;
    private AtomicInteger access = new AtomicInteger(0);
    private long txStart = 0;
    private long rxStart = 0;
