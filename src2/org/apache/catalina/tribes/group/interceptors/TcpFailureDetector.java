...
public class TcpFailureDetector extends ChannelInterceptorBase {
    ...
    private static byte[] TCP_FAIL_DETECT = new byte[] {
    ...
    @Deprecated
    private boolean performConnectTest = true;//Unused - will be removed in Tomcat 8.0.x

    private long connectTimeout = 1000;//1 second default

    private boolean performSendTest = true;

    private boolean performReadTest = false;

    private long readTestTimeout = 5000;//5 seconds

    private Membership membership = null;

    private HashMap<Member, Long> removeSuspects = new HashMap<Member, Long>();

    private HashMap<Member, Long> addSuspects = new HashMap<Member, Long>();

    private int removeSuspectsTimeout = 300; // 5 minutes
