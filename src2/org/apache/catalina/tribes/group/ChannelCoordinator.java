...
public class ChannelCoordinator extends ChannelInterceptorBase implements MessageListener {
    ...
    public ChannelCoordinator() {
        // Override default
        this.setOptionFlag(Channel.SEND_OPTIONS_BYTE_MESSAGE |
    ...
    public void sendMessage(Member[] destination, ChannelMessage msg, InterceptorPayload payload) throws ChannelException {
        ...
        if ( Logs.getMessages().isTraceEnabled() ) {
            Logs.getMessages().trace("ChannelCoordinator - Sent msg:" + new UniqueId(msg.getUniqueId()) + " at " +new java.sql.Timestamp(System.currentTimeMillis())+ " to "+Arrays.toNameString(destination));
        }
    }
    ...
    public void messageReceived(ChannelMessage msg) {
        if ( Logs.getMessages().isTraceEnabled() ) {
            Logs.getMessages().trace("ChannelCoordinator - Received msg:" + new UniqueId(msg.getUniqueId()) + " at " +new java.sql.Timestamp(System.currentTimeMillis())+ " from "+msg.getAddress().getName());
        }
