...
public abstract class ValveBase extends LifecycleMBeanBase implements
	 ...
	 */
	private static final String info = "org.apache.catalina.core.ValveBase/1.0";
	 ...
	 */
	private static final StringManager3 sm = StringManager3.getManager(Constants22
			.getPackage());
	...
	protected void initInternal() throws LifecycleException {
		...
		setContainerLog(getContainer().getLogger());
	}
