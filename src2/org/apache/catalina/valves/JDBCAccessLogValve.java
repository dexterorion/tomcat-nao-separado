   ...
   */
          ...
          while (numberOfTries>0) {
            try {
                ...
                // Log the problem for posterity
                  getContainer().getLogger().error(getSm().getString("jdbcAccessLogValve.exception"), e);
    ...
    protected void close() {
        ...
        try {
            ...
            getContainer().getLogger().error(getSm().getString("jdbcAccessLogValeve.close"), e); // Just log it here
        } finally {
           this.conn = null;
        }
