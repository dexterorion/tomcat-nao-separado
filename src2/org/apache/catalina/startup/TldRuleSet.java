...
public class TldRuleSet extends RuleSetBase {
    ...
    public void addRuleInstances(Digester digester) {
    	...
    	TldRuleSetTaglibUriRule taglibUriRule = new TldRuleSetTaglibUriRule(); 

        digester.addRule(prefix + "taglib", new TldRuleSetTaglibRule(taglibUriRule));
        
        digester.addRule(prefix + "taglib/uri", taglibUriRule);

        digester.addRule(prefix + "taglib/listener/listener-class",
                new TldRuleSetTaglibListenerRule(taglibUriRule));
