...
public class SSIServletExternalResolver implements SSIExternalResolver {
                ...
                if (nameParts.length == 2) {
                    ...
                    if (queryString != null) {
                        ...
                        String queryStringEncoding =
                            Constants24.getDefaultCharacterEncoding();
    ...
    protected String getAbsolutePath(String path) throws IOException {
        ...
        String retVal = RequestUtil2.normalize(fullPath);
        if (retVal == null) {
    ...
    protected SSIServletExternalResolverServletContextAndPath getServletContextAndPathFromNonVirtualPath(
        ...
        SSIServletExternalResolverServletContextAndPath csAndP = new SSIServletExternalResolverServletContextAndPath(
                context, path);
        return csAndP;
    }


    protected SSIServletExternalResolverServletContextAndPath getServletContextAndPathFromVirtualPath(
            String virtualPath) throws IOException {

        if (!virtualPath.startsWith("/") && !virtualPath.startsWith("\\")) {
            return new SSIServletExternalResolverServletContextAndPath(context,
                    getAbsolutePath(virtualPath));
        }

        String normalized = RequestUtil2.normalize(virtualPath);
        if (isVirtualWebappRelative) {
            return new SSIServletExternalResolverServletContextAndPath(context, normalized);
        }
        ...
        if (!isRootContext(normContext)) {
            ...
            return new SSIServletExternalResolverServletContextAndPath(normContext, noContext);
        }

        return new SSIServletExternalResolverServletContextAndPath(normContext, normalized);
    }
    ...
    protected SSIServletExternalResolverServletContextAndPath getServletContextAndPath(
            String originalPath, boolean virtual) throws IOException {
    	SSIServletExternalResolverServletContextAndPath csAndP = null;
        if (debug > 0) {
    ...
    protected URLConnection getURLConnection(String originalPath,
    	...
    	SSIServletExternalResolverServletContextAndPath csAndP = getServletContextAndPath(originalPath,
                virtual);
    ...
    public String getFileText(String originalPath, boolean virtual)
            throws IOException {
        try {
        	SSIServletExternalResolverServletContextAndPath csAndP = getServletContextAndPath(
            ...
            if (retVal.equals("") && !req.getMethod().equalsIgnoreCase(
                    org.apache.coyote.http11.Constants26.getHead())) {
