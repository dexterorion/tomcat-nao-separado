...
public class ClusterSingleSignOn extends SingleSignOn {
	 ...
	 */
	private static final String info = "org.apache.catalina.ha.authenticator.ClusterSingleSignOn";
	...
	protected void associate(String ssoId, Session2 session) {
		...
		if (cluster != null && cluster.getMembers().length > 0) {
			...
			msg.setAction(SingleSignOnMessage.getAddSession());

			cluster.send(msg);

			if (getContainerLog().isDebugEnabled())
				getContainerLog().debug(
						"SingleSignOnMessage Send with action "
								+ msg.getAction());
		}
	...
	protected void associateLocal(String ssoId, Session2 session) {
	...
	protected void deregister(String ssoId, Session2 session) {
		...
		if (cluster != null && cluster.getMembers().length > 0) {
			...
			msg.setAction(SingleSignOnMessage.getDeregisterSession());
	...
	protected void deregisterLocal(String ssoId, Session2 session) {
	...
	protected void deregister(String ssoId) {
		...
		if (cluster != null && cluster.getMembers().length > 0) {
			...
			msg.setAction(SingleSignOnMessage.getLogoutSession());
	...
	protected void register(String ssoId, Principal principal, String authType,
		...
		if (cluster != null && cluster.getMembers().length > 0) {
			...
			SingleSignOnMessage msg = new SingleSignOnMessage(
					cluster.getLocalMember(), ssoId, null);
			msg.setAction(SingleSignOnMessage.getRegisterSession());
	...
	protected void update(String ssoId, Principal principal, String authType,
		...
		if (cluster != null && cluster.getMembers().length > 0) {
			...
			SingleSignOnMessage msg = new SingleSignOnMessage(
					cluster.getLocalMember(), ssoId, null);
			msg.setAction(SingleSignOnMessage.getUpdateSession());
			msg.setAuthType(authType);
			msg.setUsername(username);
			msg.setPassword(password);
	...
	protected void removeSession(String ssoId, Session2 session) {
		...
		if (cluster != null && cluster.getMembers().length > 0) {
			...
			msg.setAction(SingleSignOnMessage.getRemoveSession());
	...
	protected void removeSessionLocal(String ssoId, Session2 session) {
