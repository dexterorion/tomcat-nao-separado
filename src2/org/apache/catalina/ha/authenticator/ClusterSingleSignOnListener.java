...
public class ClusterSingleSignOnListener extends ClusterListener {
     ...
     */
    private static final String info = "org.apache.catalina.ha.authenticator.ClusterSingleSignOnListener/1.0";
    ...
    private Session2 getSession(String sessionId, String ctxname) {
