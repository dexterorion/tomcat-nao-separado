...
public class SingleSignOnMessage implements ClusterMessage {
    ...
    private static final int ADD_SESSION = 1;
    private static final int DEREGISTER_SESSION = 2;
    private static final int LOGOUT_SESSION = 3;
    private static final int REGISTER_SESSION = 4;
    private static final int UPDATE_SESSION = 5;
    private static final int REMOVE_SESSION = 6;
	...
	public static int getAddSession() {
		return ADD_SESSION;
	}

	public static int getDeregisterSession() {
		return DEREGISTER_SESSION;
	}

	public static int getLogoutSession() {
		return LOGOUT_SESSION;
	}

	public static int getUpdateSession() {
		return UPDATE_SESSION;
	}

	public static int getRegisterSession() {
		return REGISTER_SESSION;
	}

	public static int getRemoveSession() {
