...
public class JvmRouteBinderValve extends ValveBase implements ClusterValve {
	...
	/*--Static Variables----------------------------------------*/
	private static final Log log = LogFactory.getLog(JvmRouteBinderValve.class);

	/**
	 * The descriptive information about this implementation.
	 */
	private static final String info = "org.apache.catalina.ha.session.JvmRouteBinderValve/1.2";
	...
	private String sessionIdAttribute = "org.apache.catalina.ha.session.JvmRouteOrignalSessionID";
	...
	protected void changeSessionID(Request request, String sessionId,
			String newSessionID, Session2 catalinaSession) {
