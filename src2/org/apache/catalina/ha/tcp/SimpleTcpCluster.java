...
public class SimpleTcpCluster extends LifecycleMBeanBase implements
	...
	private static final Log log = LogFactory.getLog(SimpleTcpCluster.class);
	 ...
	 */
	private static final String info = "SimpleTcpCluster/2.2";

	private static final String BEFORE_MEMBERREGISTER_EVENT = "before_member_register";

	private static final String AFTER_MEMBERREGISTER_EVENT = "after_member_register";

	private static final String BEFORE_MANAGERREGISTER_EVENT = "before_manager_register";

	private static final String AFTER_MANAGERREGISTER_EVENT = "after_manager_register";

	private static final String BEFORE_MANAGERUNREGISTER_EVENT = "before_manager_unregister";

	private static final String AFTER_MANAGERUNREGISTER_EVENT = "after_manager_unregister";

	private static final String BEFORE_MEMBERUNREGISTER_EVENT = "before_member_unregister";

	private static final String AFTER_MEMBERUNREGISTER_EVENT = "after_member_unregister";

	private static final String SEND_MESSAGE_FAILURE_EVENT = "send_message_failure";

	private static final String RECEIVE_MESSAGE_FAILURE_EVENT = "receive_message_failure";

	/**
	 * Group channel.
	 */
	private Channel channel = new GroupChannel();

	/**
	 * Name for logging purpose
	 */
	private String clusterImpName = "SimpleTcpCluster";

	/**
	 * The string manager for this package.
	 */
	private static final StringManager3 sm = StringManager3.getManager(Constants8
			.getPackage());
	 ...
	 */
	private boolean heartbeatBackgroundEnabled = false;
	 ...
	 */
	private Map<String, ClusterManager> managers = new HashMap<String, ClusterManager>();

	private ClusterManager managerTemplate = new DeltaManager();
