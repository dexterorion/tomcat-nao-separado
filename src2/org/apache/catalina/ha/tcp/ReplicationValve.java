...
public class ReplicationValve extends ValveBase implements ClusterValve {
	 ...
	 */
	private ThreadLocal<ArrayList<DeltaSession>> crossContextSessions = new ThreadLocal<ArrayList<DeltaSession>>();

	/**
	 * doProcessingStats (default = off)
	 */
	private boolean doProcessingStats = false;

	private long totalRequestTime = 0;
	private long totalSendTime = 0;
	private long nrOfRequests = 0;
	private long lastSendTime = 0;
	private long nrOfFilterRequests = 0;
	private long nrOfSendRequests = 0;
	private long nrOfCrossContextSendRequests = 0;
	 ...
	 */
	private String primaryIndicatorName = "org.apache.catalina.ha.tcp.isPrimarySession";
	...
	protected void resetReplicationRequest(Request request,
		...
		Session2 contextSession = request.getSessionInternal(false);
	 ...
	 */
	protected void resetDeltaRequest(Session2 session) {
		if (log.isDebugEnabled()) {
	 ...
	 *            replication cluster
	 */
	protected void sendMessage(Session2 session, ClusterManager manager,
	...
	protected void createPrimaryIndicator(Request request) throws IOException {
		...
		if ((id != null) && (id.length() > 0)) {
			...
			Session2 session = manager.findSession(id);
