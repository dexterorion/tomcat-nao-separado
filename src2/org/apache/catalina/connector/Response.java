...
public class Response implements HttpServletResponse {
	 ...
	 */
	private static final String info = "org.apache.coyote.catalina.CoyoteResponse/1.0";

	/**
	 * The string manager for this package.
	 */
	private static final StringManager3 sm = StringManager3
			.getManager(Constants2.getPackage());
	 ...
	 * Coyote response.
	 */
	private Response3 coyoteResponse;
	 ...
	 *            The Coyote response
	 */
	public void setCoyoteResponse(Response3 coyoteResponse) {
	 ...
	 */
	public Response3 getCoyoteResponse() {
	 ...
	 */
	private CoyoteOutputStream outputStream;

	/**
	 * The associated writer.
	 */
	private CoyoteWriter writer;

	/**
	 * The application commit flag.
	 */
	private boolean appCommitted = false;
	 ...
	 */
	private CharChunk redirectURLCC = new CharChunk();
	 ...
	 */
	private ResponseFacade facade = null;
	...
	public void addDateHeader(String name, long value) {
		...
		if (format == null) {
			format = new SimpleDateFormat(DateTool.getHttpResponseDateHeader(),
					Locale.US);
	...
	/**
	 * An extended version of this exists in {@link org.apache.coyote.Response3}.
	 ...
	 * visible to {@link org.apache.coyote.Response3}
	 *
	...
	protected boolean isEncodeable(final String location) {
		...
		final Session2 session = hreq.getSessionInternal(false);
		if (session == null) {
			return (false);
		}
	...
	private boolean doIsEncodeable(Request hreq, Session2 session,
			String location) {
	...
	protected String toEncoded(String url, String sessionId) {
		...
		if (sb.length() > 0) { // jsessionid can't be first.
			sb.append(";");
			sb.append(SessionConfig2.getSessionUriParamName(request.getContext()));
			sb.append("=");
			sb.append(sessionId);
		}
		sb.append(anchor);
