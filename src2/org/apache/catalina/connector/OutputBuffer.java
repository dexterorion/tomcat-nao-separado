 ...
 */
public class OutputBuffer extends Writer implements ByteChunkByteOutputChannel,
		CharChunkCharOutputChannel {

	// -------------------------------------------------------------- Constants

	private static final String DEFAULT_ENCODING = Constants24.getDefaultCharacterEncoding();
	 ...
	 * List of encoders.
	 */
	private HashMap<String, C2BConverter> encoders = new HashMap<String, C2BConverter>();

	/**
	 * Current char to byte converter.
	 */
	private C2BConverter conv;
	 ...
	 *            Associated Coyote response
	 */
	public void setResponse(Response3 coyoteResponse) {
	...
	public void close() throws IOException {
		...
		Request req = (Request) coyoteResponse.getRequest().getNote(
				CoyoteAdapter.getAdapterNotes());
		req.getInputBuffer().close();
