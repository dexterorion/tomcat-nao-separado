...
import org.apache.tomcat.util.buf.ByteChunkByteInputChannel;
import org.apache.tomcat.util.buf.CharChunk;
import org.apache.tomcat.util.buf.CharChunkCharInputChannel;
import org.apache.tomcat.util.buf.CharChunkCharOutputChannel;
 ...
 */
public class InputBuffer extends Reader implements ByteChunkByteInputChannel,
		CharChunkCharInputChannel, CharChunkCharOutputChannel {
	...
	private static final String DEFAULT_ENCODING = Constants24
	...
	private final int CHAR_STATE = 1;
	private final int BYTE_STATE = 2;
	 ...
	 * List of encoders.
	 */
	private HashMap<String, B2CConverter> encoders = new HashMap<String, B2CConverter>();

	/**
	 * Current byte to char converter.
	 */
	private B2CConverter conv;
	 ...
	 *            Associated Coyote request
	 */
	public void setRequest(Request2 coyoteRequest) {
