...
public class RequestFacade implements HttpServletRequest {
    ...
    public Enumeration<String> getAttributeNames() {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetAttributePrivilegedAction(this));
        } else {
    ...
    public String getCharacterEncoding() {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetCharacterEncodingPrivilegedAction(this));
        } else {
    ...
    public String getParameter(String name) {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetParameterPrivilegedAction(this, name));
        } else {
    ...
    public Enumeration<String> getParameterNames() {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetParameterNamesPrivilegedAction(this));
        } else {
    ...
    public String[] getParameterValues(String name) {
        ...
        if (SecurityUtil.isPackageProtectionEnabled()){
            ret = AccessController.doPrivileged(
                new RequestFacadeGetParameterValuePrivilegedAction(this, name));
            if (ret != null) {
                ret = ret.clone();
            }
        } else {
    ...
    public Map<String,String[]> getParameterMap() {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetParameterMapPrivilegedAction(this));
        } else {
    ...
    public Locale getLocale() {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetLocalePrivilegedAction(this));
        } else {
    ...
    public Enumeration<Locale> getLocales() {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetLocalesPrivilegedAction(this));
        } else {
    ...
    public RequestDispatcher getRequestDispatcher(String path) {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetRequestDispatcherPrivilegedAction(this, path));
        } else {
    ...
    public Cookie[] getCookies() {
        ...
        if (SecurityUtil.isPackageProtectionEnabled()){
            ret = AccessController.doPrivileged(
                new RequestFacadeGetCookiesPrivilegedAction(this));
            if (ret != null) {
                ret = ret.clone();
            }
        } else {
    ...
    public Enumeration<String> getHeaders(String name) {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetHeadersPrivilegedAction(this, name));
        } else {
    ...
    public Enumeration<String> getHeaderNames() {
        ...
        if (Globals.isSecurityEnabled()){
            return AccessController.doPrivileged(
                new RequestFacadeGetHeaderNamesPrivilegedAction(this));
        } else {
    ...
    public HttpSession getSession(boolean create) {
        ...
        if (SecurityUtil.isPackageProtectionEnabled()){
            return AccessController.
                doPrivileged(new RequestFacadeGetSessionPrivilegedAction(this, create));
        } else {
