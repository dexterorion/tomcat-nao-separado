...
public class FactoryCreateRule extends Rule {
		...
		if (ignoreCreateExceptions) {
			...
			try {
				...
				if (getDigester().getLog().isDebugEnabled()) {
					getDigester().getLog().debug(
							"[FactoryCreateRule]{" + getDigester().getMatch()
				...
				if (getDigester().getLog().isInfoEnabled()) {
					getDigester().getLog().info(
			...
			if (getDigester().getLog().isDebugEnabled()) {
				getDigester().getLog().debug(
						"[FactoryCreateRule]{" + getDigester().getMatch() + "} New "
	...
	public void end(String namespace, String name) throws Exception {
		...
		if (getDigester().getLog().isDebugEnabled()) {
			getDigester().getLog().debug(
					"[FactoryCreateRule]{" + getDigester().getMatch() + "} Pop "
