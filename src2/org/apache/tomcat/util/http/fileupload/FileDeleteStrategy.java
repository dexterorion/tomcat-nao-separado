...
public class FileDeleteStrategy {
     ...
     */
    private static final FileDeleteStrategy NORMAL = new FileDeleteStrategy("Normal");
     ...
     */
    public FileDeleteStrategy(String name) {
        this.name = name;
    }
    ...
    public static FileDeleteStrategy getNormal() {
		return NORMAL;
	}
