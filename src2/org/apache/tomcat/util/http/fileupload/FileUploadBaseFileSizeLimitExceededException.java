...
public class FileUploadBaseFileSizeLimitExceededException extends FileUploadBaseSizeException {
	 ...
	 */
	public FileUploadBaseFileSizeLimitExceededException(String message, long actual,
			long permitted) {
