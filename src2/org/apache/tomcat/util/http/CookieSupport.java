...
public final class CookieSupport {
     ...
     * being quoted.
     */
    private static final boolean ALLOW_EQUALS_IN_VALUE;
     ...
     */
    private static final boolean ALLOW_NAME_ONLY;
	...
	public static boolean isAllowEqualsInValue() {
		return ALLOW_EQUALS_IN_VALUE;
	}

	public static boolean isAllowHttpSeparatorsInV0() {
		return ALLOW_HTTP_SEPARATORS_IN_V0;
	}

	public static boolean isAlwaysAddExpires() {
		return ALWAYS_ADD_EXPIRES;
	}

	public static boolean isAllowNameOnly() {
		return ALLOW_NAME_ONLY;
	}
}
