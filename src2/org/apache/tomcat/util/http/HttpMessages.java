...
public class HttpMessages {
    ...
    private static final HttpMessages DEFAULT = new HttpMessages(
            StringManager3.getManager("org.apache.tomcat.util.http.res",
                    Locale.getDefault()));


    // XXX move message resources in this package
    private final StringManager3 sm;
    ...
    public HttpMessages(StringManager3 sm) {
        this.sm = sm;
    }
    ...
    public static HttpMessages getInstance(Locale locale) {
        ...
        if (result == null) {
            StringManager3 sm = StringManager3.getManager(
