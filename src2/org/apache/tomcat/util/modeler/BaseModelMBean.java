...
public class BaseModelMBean implements DynamicMBean, MBeanRegistration,
	 ...
	 */
	public BaseModelMBean() throws MBeanException,
	 ...
	 */
	private BaseNotificationBroadcaster attributeBroadcaster = null;

	/**
	 * Notification broadcaster for general notifications.
	 */
	private BaseNotificationBroadcaster generalBroadcaster = null;
	...
	private static final Object[] NO_ARGS_PARAM = new Object[0];
	private static final Class<?>[] NO_ARGS_PARAM_SIG = new Class[0];
	...
	public static Class<?> getAttributeClass(String signature)
	...
	public BaseNotificationBroadcaster getAttributeBroadcaster() {
		return attributeBroadcaster;
	}

	public void setAttributeBroadcaster(
			BaseNotificationBroadcaster attributeBroadcaster) {
		this.attributeBroadcaster = attributeBroadcaster;
	}

	public BaseNotificationBroadcaster getGeneralBroadcaster() {
		return generalBroadcaster;
	}

	public void setGeneralBroadcaster(
			BaseNotificationBroadcaster generalBroadcaster) {
		this.generalBroadcaster = generalBroadcaster;
	}
	...
	public static Object[] getNoArgsParam() {
		return NO_ARGS_PARAM;
	}

	public static Class<?>[] getNoArgsParamSig() {
		return NO_ARGS_PARAM_SIG;
	}
