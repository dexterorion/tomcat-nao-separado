...
public class ConstructorInfo extends OperationInfo {
	private static final long serialVersionUID = -5735336213417238238L;
    // ------------------------------------------------------------- Properties
    ...
    public MBeanConstructorInfo createConstructorInfo() {
        ...
        if (getInfo() == null) {
            setInfo(new MBeanConstructorInfo(getName(), getDescription(), 
                    getMBeanParameterInfo()));
        }
        return (MBeanConstructorInfo)getInfo();
    }
