            ...
            if (filter instanceof BaseAttributeFilter) {
                ...
                while (items.hasNext()) {
                    ...
                    if ((item.getListener() == listener) &&
                        (item.getFilter() != null) &&
                        (item.getFilter() instanceof BaseAttributeFilter) &&
                        (item.getHandback() == handback)) {
                        BaseAttributeFilter oldFilter =
                            (BaseAttributeFilter) item.getFilter();
        ...
        synchronized (entries) {
            ...
            while (items.hasNext()) {
                ...
                if ((item.getFilter() != null) &&
                    (!item.getFilter().isNotificationEnabled(notification)))
                    continue;
                item.getListener().handleNotification(notification, item.getHandback());
            }
        }
