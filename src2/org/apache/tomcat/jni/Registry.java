...
public class Registry {
	...
	private static final int KEY_ALL_ACCESS          = 0x0001;
	private static final int KEY_CREATE_LINK         = 0x0002;
	private static final int KEY_CREATE_SUB_KEY      = 0x0004;
	private static final int KEY_ENUMERATE_SUB_KEYS  = 0x0008;
	private static final int KEY_EXECUTE             = 0x0010;
	private static final int KEY_NOTIFY              = 0x0020;
	private static final int KEY_QUERY_VALUE         = 0x0040;
	private static final int KEY_READ                = 0x0080;
	private static final int KEY_SET_VALUE           = 0x0100;
	private static final int KEY_WOW64_64KEY         = 0x0200;
	private static final int KEY_WOW64_32KEY         = 0x0400;
	private static final int KEY_WRITE               = 0x0800;

	private static final int REG_BINARY              = 1;
	private static final int REG_DWORD               = 2;
	private static final int REG_EXPAND_SZ           = 3;
	private static final int REG_MULTI_SZ            = 4;
	private static final int REG_QWORD               = 5;
	private static final int REG_SZ                  = 6;
