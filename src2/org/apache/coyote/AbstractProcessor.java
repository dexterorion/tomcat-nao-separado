...
public abstract class AbstractProcessor<S> implements ActionHook, Processor<S> {
    ...
    private static final StringManager3 sm = StringManager3.getManager(Constants24.getPackage());

    private Adapter adapter;
    private AsyncStateMachine<S> asyncStateMachine;
    private AbstractEndpoint<S> endpoint;
    private Request2 request;
    private Response3 response;
    private SocketWrapper<S> socketWrapper = null;
	...
	public AsyncStateMachine<S> getAsyncStateMachine() {
		return asyncStateMachine;
	}

	public void setAsyncStateMachine(AsyncStateMachine<S> asyncStateMachine) {
