...
public class RequestInfo  {
    ...
    public RequestInfo( Request2 req) {
        this.req=req;
    }
    ...
    private int stage = Constants24.getStageNew();
    ...
    public String getRemoteAddrForwarded() {
        String remoteAddrProxy = (String) req.getAttribute(Constants24.getRemoteAddrAttribute());
    ...
    public long getRequestProcessingTime() {
        if ( getStage() == Constants24.getStageEnded() ) return 0;
