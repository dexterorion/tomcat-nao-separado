...
public final class Response3 {
     ...
     * Notes.
     */
    private Object notes[] = new Object[Constants24.getMaxNotes()];
    ...
    private String characterEncoding = Constants24.getDefaultCharacterEncoding();
    ...
    public void setRequest( Request2 req ) {
        this.req=req;
    }
    ...
    public void recycle() {
        ...
        characterEncoding = Constants24.getDefaultCharacterEncoding();
        charsetSet = false;
        contentLength = -1;
        status = 200;
        message = null;
