...
import org.apache.coyote.http11.Constants26;
...
public class ChunkedInputFilter implements InputFilter {
    ...
    private static final StringManager3 sm = StringManager3.getManager(
            ChunkedInputFilter.class.getPackage().getName());


    // -------------------------------------------------------------- Constants

    private static final String ENCODING_NAME = "chunked";
     ...
     */
    private ByteChunk trailingHeaders = new ByteChunk();
     ...
     */
    private boolean needCRLFParse = false;
    ...
    protected boolean parseChunkHeader() throws IOException {
        ...
        while (!eol) {
            ...
            if (buf[pos] == Constants26.getCr() || buf[pos] == Constants26.getLf()) {
                parseCRLF(false);
                eol = true;
            } else if (buf[pos] == Constants26.getSemiColon() && !extension) {
    ...
    private boolean parseHeader() throws IOException {
        ...
        if (chr == Constants26.getCr() || chr == Constants26.getLf()) {
            parseCRLF(false);
            return false;
        }
        ...
        while (!colon) {
            ...
            if ((chr >= Constants26.getA()) && (chr <= Constants26.getZ())) {
                chr = (byte) (chr - Constants26.getLcOffset());
            }
