...
public final class AstFunction extends SimpleNode {
    ...
    public Class<?> getType(EvaluationContext ctx)
        ...
        FunctionMapper2 fnMapper = ctx.getFunctionMapper();
        ...
        if (numParams > 0) {
            ...
            try {
                for (int i = 0; i < numParams; i++) {
                    params[i] = this.getChildren()[i].getValue(ctx);
    ...
    {
        return ELParserTreeConstants.jjtNodeName[getId()] + "[" + this.getOutputName() + "]";
    }
}
